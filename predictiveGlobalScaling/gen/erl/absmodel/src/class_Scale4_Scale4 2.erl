...
'm_deploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(this, C:set_val_internal(get(this), 'ls_ImageRecognizerInterface',[maps:get('odefault___ImageRecognizer_0_c4_4xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_ImageRecognizerInterface')])),
         %% Scale4.abs:189--189
        put(vars, (get(vars))#{'odefault___SentimentAnalyser_0_c4_4xlarge_1' => object:new(cog:start(Cog,maps:get('c4_4xlarge_1', get(vars))),class_EmailProcessingPipelineArchitecture_SentimentAnalyser,[[]],Cog,[O,DC| Stack])}),
         %% Scale4.abs:190--190
        put(vars, (get(vars))#{'coreRequired_odefault___SentimentAnalyser_0_c4_4xlarge_1' => 4}),
         %% Scale4.abs:191--191
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_4xlarge_1', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_4xlarge_1', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___SentimentAnalyser_0_c4_4xlarge_1', get(vars)))) ,[O,DC| Stack])}),
         %% Scale4.abs:192--192
        put(this, C:set_val_internal(get(this), 'ls_SentimentAnalyserInterface',[maps:get('odefault___SentimentAnalyser_0_c4_4xlarge_1', get(vars)) | C:get_val_internal(get(this), 'ls_SentimentAnalyserInterface')])),
         %% Scale4.abs:193--193
        ...
        put(this, C:set_val_internal(get(this), 'ls_ImageAnalyserInterface',[maps:get('odefault___ImageAnalyser_0_c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_ImageAnalyserInterface')])),
         %% Scale4.abs:221--221
        put(vars, (get(vars))#{'odefault___AttachmentsManager_0_c4_large_0' => object:new(cog:start(Cog,maps:get('c4_large_0', get(vars))),class_EmailProcessingPipelineArchitecture_AttachmentsManager,[C:get_val_internal(get(this), 'imageAnalyser_LoadBalancerObj'),[]],Cog,[O,DC| Stack])}),
         %% Scale4.abs:222--222
        ...
        put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',[maps:get('odefault___VirusScanner_0_c4_xlarge_2', get(vars)) | C:get_val_internal(get(this), 'ls_VirusScannerInterface')])),
         %% Scale4.abs:233--233
        put(vars, (get(vars))#{'odefault___MessageParser_0_c4_4xlarge_0' => object:new(cog:start(Cog,maps:get('c4_4xlarge_0', get(vars))),class_EmailProcessingPipelineArchitecture_MessageParser,[C:get_val_internal(get(this), 'headerAnalyser_LoadBalancerObj'),C:get_val_internal(get(this), 'linkAnalyser_LoadBalancerObj'),C:get_val_internal(get(this), 'textAnalyser_LoadBalancerObj'),C:get_val_internal(get(this), 'virusScanner_LoadBalancerObj'),C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj'),C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% Scale4.abs:234--234
        put(vars, (get(vars))#{'coreRequired_odefault___MessageParser_0_c4_4xlarge_0' => 1}),
         %% Scale4.abs:235--235
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_4xlarge_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_4xlarge_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___MessageParser_0_c4_4xlarge_0', get(vars)))) ,[O,DC| Stack])}),
         %% Scale4.abs:236--236
        put(this, C:set_val_internal(get(this), 'ls_MessageParserInterface',[maps:get('odefault___MessageParser_0_c4_4xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_MessageParserInterface')])),
         %% Scale4.abs:237--237
        put(vars, (get(vars))#{'odefault___MessageReceiver_0_c4_4xlarge_0' => object:new(cog:start(Cog,maps:get('c4_4xlarge_0', get(vars))),class_EmailProcessingPipelineArchitecture_MessageReceiver,[C:get_val_internal(get(this), 'messageParser_LoadBalancerObj'),[]],Cog,[O,DC| Stack])}),
         %% Scale4.abs:238--238
        put(vars, (get(vars))#{'coreRequired_odefault___MessageReceiver_0_c4_4xlarge_0' => 1}),
         %% Scale4.abs:239--239
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_4xlarge_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_4xlarge_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___MessageReceiver_0_c4_4xlarge_0', get(vars)))) ,[O,DC| Stack])}),
         %% Scale4.abs:240--240
        put(this, C:set_val_internal(get(this), 'ls_MessageReceiverInterface',[maps:get('odefault___MessageReceiver_0_c4_4xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_MessageReceiverInterface')])),
         %% Scale4.abs:241--241
        ...
        T_3 = (fun() -> case C:get_val_internal(get(this), 'sentimentAnalyser_LoadBalancerObj') of
            ...
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___SentimentAnalyser_0_c4_4xlarge_1', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___SentimentAnalyser_0_c4_4xlarge_1', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___SentimentAnalyser_0_c4_4xlarge_1', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog, true),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_3,
         %% Scale4.abs:245--245
        T_4 = (fun() -> case C:get_val_internal(get(this), 'nsfwDetector_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
        ...
        T_4,
         %% Scale4.abs:246--246
        T_5 = (fun() -> case C:get_val_internal(get(this), 'nsfwDetector_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
        ...
        T_11 = (fun() -> case C:get_val_internal(get(this), 'attachmentsManager_LoadBalancerObj') of
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___AttachmentsManager_0_c4_large_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog, true),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_11,
         %% Scale4.abs:253--253
        ...
        T_13,
         %% Scale4.abs:255--255
        T_14 = (fun() -> case C:get_val_internal(get(this), 'messageParser_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___MessageParser_0_c4_4xlarge_0', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___MessageParser_0_c4_4xlarge_0', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___MessageParser_0_c4_4xlarge_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog, true),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_14,
         %% Scale4.abs:256--256
        T_15 = (fun() -> case C:get_val_internal(get(this), 'messageReceiver_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___MessageReceiver_0_c4_4xlarge_0', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___MessageReceiver_0_c4_4xlarge_0', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___MessageReceiver_0_c4_4xlarge_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog, true),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_15,
        dataUnit
...
'm_undeploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(vars, (get(vars))#{'odefault___ImageRecognizer_0_c4_4xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_ImageRecognizerInterface'),0,[O,DC| Stack])}),
         %% Scale4.abs:261--261
        put(vars, (get(vars))#{'odefault___SentimentAnalyser_0_c4_4xlarge_1' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_SentimentAnalyserInterface'),0,[O,DC| Stack])}),
         %% Scale4.abs:262--262
        ...
        put(vars, (get(vars))#{'odefault___VirusScanner_0_c4_xlarge_2' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_VirusScannerInterface'),1,[O,DC| Stack])}),
         %% Scale4.abs:272--272
        put(vars, (get(vars))#{'odefault___MessageParser_0_c4_4xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_MessageParserInterface'),0,[O,DC| Stack])}),
         %% Scale4.abs:273--273
        put(vars, (get(vars))#{'odefault___MessageReceiver_0_c4_4xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_MessageReceiverInterface'),0,[O,DC| Stack])}),
         %% Scale4.abs:274--274
        ...
        T_4,
         %% Scale4.abs:278--278
        T_5 = (fun() -> case C:get_val_internal(get(this), 'imageRecognizer_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
        ...
        T_6,
         %% Scale4.abs:280--280
        T_7 = (fun() -> case C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
        ...
        T_8,
         %% Scale4.abs:282--282
        T_9 = (fun() -> case C:get_val_internal(get(this), 'imageAnalyser_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
        ...
        []=(fun Loop ([])->
            ...
            true -> receive
                 ...
                 %% Scale4.abs:289--289
                T_15 = (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
                    null -> throw(dataNullPointerException);
                    Callee=#object{oid=Oid,cog=Cog} ->
                        %% self-call
                        Vars=get(vars),
...
'm_patchSpeed'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_dcs_0,Stack)->
 ...
 'dcs' => V_dcs_0 }),
    try
         %% Scale4.abs:295--308
        put(vars, (get(vars))#{'tmp1497194297' => m_ABS_StdLib_funs:f_entries(Cog,maps:get('dcs', get(vars)),[O,DC| Stack])}),
         %% Scale4.abs:295--308
        []=(fun Loop ([])->
            case not (m_ABS_StdLib_funs:f_isEmpty(Cog,maps:get('tmp1497194297', get(vars)),[O,DC| Stack])) of
            false -> [];
            true -> receive
                    {stop_world, CogRef} ->
                        cog:task_is_blocked_for_gc(Cog, self(), get(task_info), get(this)),
                 ...
                 %% Scale4.abs:295--308
                put(vars, (get(vars))#{'entry' => m_ABS_StdLib_funs:f_head(Cog,maps:get('tmp1497194297', get(vars)),[O,DC| Stack])}),
                 %% Scale4.abs:295--308
                put(vars, (get(vars))#{'tmp1497194297' := m_ABS_StdLib_funs:f_tail(Cog,maps:get('tmp1497194297', get(vars)),[O,DC| Stack])}),
                 %% Scale4.abs:296--296
                ...
                put(vars, (get(vars))#{'coreUsed' => m_ABS_StdLib_funs:f_snd(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% Scale4.abs:298--298
                put(vars, (get(vars))#{'tmp1643522944' => cog:create_task(maps:get('dc', get(vars)),'m_total',[dataSpeed,[]],#task_info{method= <<"total"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog,true)}),
                 %% Scale4.abs:298--298
                future:await(maps:get('tmp1643522944', get(vars)), Cog, [O,DC| Stack]),
                ok,
                 %% Scale4.abs:298--298
                put(vars, (get(vars))#{'speed_aux' => future:get_blocking(maps:get('tmp1643522944', get(vars)), Cog, [O,DC| Stack])}),
                 %% Scale4.abs:299--302
                ...
                case (not cmp:eq(maps:get('total_speed', get(vars)),-1)) of
                    true ->  %% Scale4.abs:304--304
                    put(vars, (get(vars))#{'tmp947633530' => cog:create_task(maps:get('dc', get(vars)),'m_getNumberOfCores',[[]],#task_info{method= <<"getNumberOfCores"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog,true)}),
                     %% Scale4.abs:304--304
                    future:await(maps:get('tmp947633530', get(vars)), Cog, [O,DC| Stack]),
                    ok,
                     %% Scale4.abs:304--304
                    put(vars, (get(vars))#{'totalCore' => future:get_blocking(maps:get('tmp947633530', get(vars)), Cog, [O,DC| Stack])}),
                     %% Scale4.abs:305--305
