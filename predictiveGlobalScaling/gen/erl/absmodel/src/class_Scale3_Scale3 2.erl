...
'm_deploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',[maps:get('odefault___VirusScanner_0_c4_xlarge_2', get(vars)) | C:get_val_internal(get(this), 'ls_VirusScannerInterface')])),
         %% Scale3.abs:203--203
        put(vars, (get(vars))#{'odefault___MessageParser_0_c4_xlarge_1' => object:new(cog:start(Cog,maps:get('c4_xlarge_1', get(vars))),class_EmailProcessingPipelineArchitecture_MessageParser,[C:get_val_internal(get(this), 'headerAnalyser_LoadBalancerObj'),C:get_val_internal(get(this), 'linkAnalyser_LoadBalancerObj'),C:get_val_internal(get(this), 'textAnalyser_LoadBalancerObj'),C:get_val_internal(get(this), 'virusScanner_LoadBalancerObj'),C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj'),C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% Scale3.abs:204--204
        put(vars, (get(vars))#{'coreRequired_odefault___MessageParser_0_c4_xlarge_1' => 1}),
         %% Scale3.abs:205--205
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_xlarge_1', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_xlarge_1', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___MessageParser_0_c4_xlarge_1', get(vars)))) ,[O,DC| Stack])}),
         %% Scale3.abs:206--206
        put(this, C:set_val_internal(get(this), 'ls_MessageParserInterface',[maps:get('odefault___MessageParser_0_c4_xlarge_1', get(vars)) | C:get_val_internal(get(this), 'ls_MessageParserInterface')])),
         %% Scale3.abs:207--207
        ...
        T_8 = (fun() -> case C:get_val_internal(get(this), 'messageParser_LoadBalancerObj') of
            ...
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___MessageParser_0_c4_xlarge_1', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___MessageParser_0_c4_xlarge_1', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___MessageParser_0_c4_xlarge_1', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog, true),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_8,
         %% Scale3.abs:220--220
        T_9 = (fun() -> case C:get_val_internal(get(this), 'messageReceiver_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
...
'm_undeploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(vars, (get(vars))#{'odefault___VirusScanner_0_c4_xlarge_2' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_VirusScannerInterface'),0,[O,DC| Stack])}),
         %% Scale3.abs:230--230
        put(vars, (get(vars))#{'odefault___MessageParser_0_c4_xlarge_1' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_MessageParserInterface'),0,[O,DC| Stack])}),
         %% Scale3.abs:231--231
...
'm_patchSpeed'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_dcs_0,Stack)->
 ...
 'dcs' => V_dcs_0 }),
    try
         %% Scale3.abs:247--260
        put(vars, (get(vars))#{'tmp1133126455' => m_ABS_StdLib_funs:f_entries(Cog,maps:get('dcs', get(vars)),[O,DC| Stack])}),
         %% Scale3.abs:247--260
        []=(fun Loop ([])->
            case not (m_ABS_StdLib_funs:f_isEmpty(Cog,maps:get('tmp1133126455', get(vars)),[O,DC| Stack])) of
            false -> [];
            true -> receive
                    {stop_world, CogRef} ->
                        cog:task_is_blocked_for_gc(Cog, self(), get(task_info), get(this)),
                 ...
                 %% Scale3.abs:247--260
                put(vars, (get(vars))#{'entry' => m_ABS_StdLib_funs:f_head(Cog,maps:get('tmp1133126455', get(vars)),[O,DC| Stack])}),
                 %% Scale3.abs:247--260
                put(vars, (get(vars))#{'tmp1133126455' := m_ABS_StdLib_funs:f_tail(Cog,maps:get('tmp1133126455', get(vars)),[O,DC| Stack])}),
                 %% Scale3.abs:248--248
                ...
                put(vars, (get(vars))#{'coreUsed' => m_ABS_StdLib_funs:f_snd(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% Scale3.abs:250--250
                put(vars, (get(vars))#{'tmp1235902593' => cog:create_task(maps:get('dc', get(vars)),'m_total',[dataSpeed,[]],#task_info{method= <<"total"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog,true)}),
                 %% Scale3.abs:250--250
                future:await(maps:get('tmp1235902593', get(vars)), Cog, [O,DC| Stack]),
                ok,
                 %% Scale3.abs:250--250
                put(vars, (get(vars))#{'speed_aux' => future:get_blocking(maps:get('tmp1235902593', get(vars)), Cog, [O,DC| Stack])}),
                 %% Scale3.abs:251--254
                ...
                case (not cmp:eq(maps:get('total_speed', get(vars)),-1)) of
                    true ->  %% Scale3.abs:256--256
                    put(vars, (get(vars))#{'tmp930748259' => cog:create_task(maps:get('dc', get(vars)),'m_getNumberOfCores',[[]],#task_info{method= <<"getNumberOfCores"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog,true)}),
                     %% Scale3.abs:256--256
                    future:await(maps:get('tmp930748259', get(vars)), Cog, [O,DC| Stack]),
                    ok,
                     %% Scale3.abs:256--256
                    put(vars, (get(vars))#{'totalCore' => future:get_blocking(maps:get('tmp930748259', get(vars)), Cog, [O,DC| Stack])}),
                     %% Scale3.abs:257--257
