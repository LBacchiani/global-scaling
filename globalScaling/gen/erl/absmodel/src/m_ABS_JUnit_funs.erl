...
'f_iterate'(Cog=#cog{ref=CogRef},V_tcs_0,Stack)->
    begin
        case V_tcs_0 of
            ...
            _ -> io:format("No match for tcs at abs/lang/abslang.abs:1354~n"), 
...
"/utf8>>]);
            _ -> io:format("No match for FnApp(tc) at abs/lang/abslang.abs:1368~n"), 
            exit(dataPatternMatchFailException)
        end
    end]), begin
...
"/utf8>>]);
            _ -> io:format("No match for FnApp(tc) at abs/lang/abslang.abs:1372~n"), 
            exit(dataPatternMatchFailException)
        end
    end]), <<"</testcase>
...
'f_iterateTS'(Cog=#cog{ref=CogRef},V_tss_0,Stack)->
    begin
        case V_tss_0 of
            ...
            _ -> io:format("No match for tss at abs/lang/abslang.abs:1384~n"), 
            exit(dataPatternMatchFailException)
        end
    end.
...
'f_tcs'(Cog=#cog{ref=CogRef},V_data_0,Stack)->
    begin
        case V_data_0 of
            ...
            _ -> io:format("No match for data at abs/lang/abslang.abs:1349~n"), 
            exit(dataPatternMatchFailException)
        end
    end.
...
'f_result'(Cog=#cog{ref=CogRef},V_data_0,Stack)->
    begin
        case V_data_0 of
            ...
            _ -> io:format("No match for data at abs/lang/abslang.abs:1351~n"), 
            exit(dataPatternMatchFailException)
        end
    end.
