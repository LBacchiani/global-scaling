-module(class_EmailProcessingPipelineArchitecture_HeaderAnalyser).
...
-record(state,{'class'=class_EmailProcessingPipelineArchitecture_HeaderAnalyser,'messageAnalyserLoadBalancer'=null}).
'init_internal'()->
    #state{}.
