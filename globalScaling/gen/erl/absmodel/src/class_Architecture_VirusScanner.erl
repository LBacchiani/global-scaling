 ...
 'balancer' => V_balancer_0 }),
    try
        ...
        put(vars, (get(vars))#{'virusFound' => cmp:eq(builtin:random(Cog,4),0)}),
         %% architecture.abs:314--314
        case maps:get('virusFound', get(vars)) of
            true ->  %% architecture.abs:314--314
            ...
            T_2;
            false ->          %% architecture.abs:315--315
