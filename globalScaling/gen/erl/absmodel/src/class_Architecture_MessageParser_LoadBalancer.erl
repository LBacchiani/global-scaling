...
implemented_interfaces() -> [ <<"Object">>, <<"MessageParser_LoadBalancerInterface">> ].

exported() -> #{  }.

%% --- Internal state and low-level accessors

-record(state,{'class'=class_Architecture_MessageParser_LoadBalancer,'db'=null,'instancesConnected'=null,'nextInstance'=null,'buffer_size'=null,'pending'=null,'id'=null}).
'init_internal'()->
    #state{}.
 ...
 'mailData' => V_mailData_0 }),
    try
        ...
        case cmp:lt(C:get_val_internal(get(this), 'pending'),C:get_val_internal(get(this), 'buffer_size')) of
            ...
            T_2 = cog:create_task(maps:get('selectedInstance', get(vars)),'m_parseMessage',[maps:get('mailData', get(vars)),O,C:get_val_internal(get(this), 'id'),[]],#task_info{method= <<"parseMessage"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog),
            T_2,
             %% architecture.abs:89--89
            put(this, C:set_val_internal(get(this), 'id',(C:get_val_internal(get(this), 'id') + 1) ));
            false ->          %% architecture.abs:90--90
