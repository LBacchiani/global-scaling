...
implemented_interfaces() -> [ <<"Object">>, <<"DeploymentComponent">>, <<"DeploymentComponentForCloudProvider">> ].
...
'init'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},[P_description,P_initconfig,Stack])->
    ...
    put(this, C:set_val_internal(get(this),'is_shutdown',false)),
     %% abs/lang/abslang.abs:1043--1044
    put(this, C:set_val_internal(get(this),'cpu',begin
        case m_ABS_StdLib_funs:f_lookup(Cog,C:get_val_internal(get(this), 'initconfig'),dataSpeed,[O,DC| Stack]) of
            ...
            _ -> io:format("No match for FnApp(initconfig,Speed()) at abs/lang/abslang.abs:1043~n"), 
    ...
    put(this, C:set_val_internal(get(this),'cpunext',C:get_val_internal(get(this), 'cpu'))),
     %% abs/lang/abslang.abs:1046--1047
    put(this, C:set_val_internal(get(this),'bw',begin
        case m_ABS_StdLib_funs:f_lookup(Cog,C:get_val_internal(get(this), 'initconfig'),dataBandwidth,[O,DC| Stack]) of
            ...
            _ -> io:format("No match for FnApp(initconfig,Bandwidth()) at abs/lang/abslang.abs:1046~n"), 
            exit(dataPatternMatchFailException)
        end
    end)),
     %% abs/lang/abslang.abs:1048--1048
    put(this, C:set_val_internal(get(this),'bwnext',C:get_val_internal(get(this), 'bw'))),
     %% abs/lang/abslang.abs:1049--1050
    ...
    put(this, C:set_val_internal(get(this),'paymentInterval',begin
        case m_ABS_StdLib_funs:f_lookup(Cog,C:get_val_internal(get(this), 'initconfig'),dataPaymentInterval,[O,DC| Stack]) of
            ...
            _ -> io:format("No match for FnApp(initconfig,PaymentInterval()) at abs/lang/abslang.abs:1053~n"), 
            exit(dataPatternMatchFailException)
        end
    end)),
        ...
        case maps:get('rtype', get(vars)) of
            dataSpeed->
                ...
                case (not cmp:eq(C:get_val_internal(get(this), 'cpu'),dataInfRat)) of
                    true ->  %% abs/lang/abslang.abs:1069--1069
            ...
            dataBandwidth->
                ...
                case (not cmp:eq(C:get_val_internal(get(this), 'bw'),dataInfRat)) of
                    true ->  %% abs/lang/abslang.abs:1074--1074
            ...
            dataMemory->
                ...
                case (not cmp:eq(C:get_val_internal(get(this), 'memory'),dataInfRat)) of
                    true ->  %% abs/lang/abslang.abs:1079--1079
            ...
            _->
                 %% abs/lang/abslang.abs:1066--1082
                throw(dataPatternMatchFailException)
        end,
         %% abs/lang/abslang.abs:1083--1083
 ...
 'rtype' => V_rtype_0 }),
    try
        ...
        case maps:get('rtype', get(vars)) of
            ...
            _->
                 %% abs/lang/abslang.abs:1087--1091
                throw(dataPatternMatchFailException)
        end,
 ...
 'rtype' => V_rtype_0 }),
    try
        ...
        case maps:get('rtype', get(vars)) of
            ...
            dataBandwidth->
                 %% abs/lang/abslang.abs:1110--1110
                case (not cmp:eq(C:get_val_internal(get(this), 'bwnext'),dataInfRat)) of
                    true ->  %% abs/lang/abslang.abs:1111--1111
            ...
            _->
                 %% abs/lang/abslang.abs:1105--1118
                throw(dataPatternMatchFailException)
        end,
    ...
    try
        ...
        case maps:get('rtype', get(vars)) of
            dataSpeed->
                ...
                case (not cmp:eq(C:get_val_internal(get(this), 'cpunext'),dataInfRat)) of
                    true ->  %% abs/lang/abslang.abs:1125--1125
            ...
            _->
                 %% abs/lang/abslang.abs:1122--1134
                throw(dataPatternMatchFailException)
        end,
...
'm_acquire'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        case (not cmp:eq(C:get_val_internal(get(this), 'cloudprovider'),null)) of
            true ->  %% abs/lang/abslang.abs:1146--1146
            put(vars, (get(vars))#{'tmp772070337' => cog:create_task(C:get_val_internal(get(this), 'cloudprovider'),'m_acquireInstance',[O,[]],#task_info{method= <<"acquireInstance"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog,true)}),
             %% abs/lang/abslang.abs:1146--1146
            future:await(maps:get('tmp772070337', get(vars)), Cog, [O,DC| Stack]),
            ok,
             %% abs/lang/abslang.abs:1146--1146
            put(vars, (get(vars))#{'result' := future:get_blocking(maps:get('tmp772070337', get(vars)), Cog, [O,DC| Stack])});
            false ->         ok
        end,
...
'm_release'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        case (not cmp:eq(C:get_val_internal(get(this), 'cloudprovider'),null)) of
            ...
            put(vars, (get(vars))#{'tmp1355506901' => cog:create_task(C:get_val_internal(get(this), 'cloudprovider'),'m_releaseInstance',[O,[]],#task_info{method= <<"releaseInstance"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog,true)}),
             %% abs/lang/abslang.abs:1153--1153
            future:await(maps:get('tmp1355506901', get(vars)), Cog, [O,DC| Stack]),
            ok,
             %% abs/lang/abslang.abs:1153--1153
            put(vars, (get(vars))#{'result' := future:get_blocking(maps:get('tmp1355506901', get(vars)), Cog, [O,DC| Stack])});
            false ->         ok
        end,
...
'm_shutdown'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        case not (C:get_val_internal(get(this), 'is_shutdown')) of
            ...
            case (not cmp:eq(C:get_val_internal(get(this), 'cloudprovider'),null)) of
                true ->  %% abs/lang/abslang.abs:1163--1163
