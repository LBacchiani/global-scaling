...
-record(state,{'class'=class_Architecture_HeaderAnalyser_LoadBalancer,'db'=null,'instancesConnected'=null,'nextInstance'=null,'buffer_size'=null}).
'init_internal'()->
    #state{}.

 %% architecture.abs:151
 ...
 'messageId' => V_messageId_0 }),
    try
        ...
        T_1 = (fun() -> case maps:get('selectedInstance', get(vars)) of
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_analyzeHeaders',[maps:get('headers', get(vars)),maps:get('messageId', get(vars)),[]],#task_info{method= <<"analyzeHeaders"/utf8>>},Cog),
