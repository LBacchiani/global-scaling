-module(class_Architecture_MessageAnalyser_LoadBalancer).
...
-record(state,{'class'=class_Architecture_MessageAnalyser_LoadBalancer,'db'=null,'instancesConnected'=null,'nextInstance'=null,'buffer_size'=null,'pending'=null}).
'init_internal'()->
    #state{}.
 ...
 'id' => V_id_0 }),
    try
        ...
        case cmp:lt(C:get_val_internal(get(this), 'pending'),C:get_val_internal(get(this), 'buffer_size')) of
            ...
            T_1 = cog:create_task(maps:get('selectedInstance', get(vars)),'m_insertResult',[maps:get('res', get(vars)),maps:get('id', get(vars)),O,[]],#task_info{method= <<"insertResult"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog),
            T_1;
            false ->          %% architecture.abs:448--448
        T_1 = (fun() -> case C:get_val_internal(get(this), 'db') of
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_messageLoss',[maps:get('id', get(vars)),[]],#task_info{method= <<"messageLoss"/utf8>>},Cog),
