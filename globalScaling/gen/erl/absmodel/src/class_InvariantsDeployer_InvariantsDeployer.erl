...
'get_val_internal'(#state{'dbObj'=G},'dbObj')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:31
'get_val_internal'(#state{'ls_ls_HeaderAnalyser_LoadBalancerInterface'=G},'ls_ls_HeaderAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:32
'get_val_internal'(#state{'ls_HeaderAnalyser_LoadBalancerInterface'=G},'ls_HeaderAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:33
...
'get_val_internal'(#state{'ls_ls_VirusScanner_LoadBalancerInterface'=G},'ls_ls_VirusScanner_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:36
'get_val_internal'(#state{'ls_VirusScanner_LoadBalancerInterface'=G},'ls_VirusScanner_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:37
'get_val_internal'(#state{'ls_ls_MessageAnalyser_LoadBalancerInterface'=G},'ls_ls_MessageAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:38
'get_val_internal'(#state{'ls_MessageAnalyser_LoadBalancerInterface'=G},'ls_MessageAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:39
'get_val_internal'(#state{'ls_ls_AttachmentsManager_LoadBalancerInterface'=G},'ls_ls_AttachmentsManager_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:40
'get_val_internal'(#state{'ls_AttachmentsManager_LoadBalancerInterface'=G},'ls_AttachmentsManager_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:41
'get_val_internal'(#state{'ls_ls_AttachmentsManagerInterface'=G},'ls_ls_AttachmentsManagerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:42
'get_val_internal'(#state{'ls_AttachmentsManagerInterface'=G},'ls_AttachmentsManagerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:43
'get_val_internal'(#state{'ls_ls_MessageParser_LoadBalancerInterface'=G},'ls_ls_MessageParser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:44
'get_val_internal'(#state{'ls_MessageParser_LoadBalancerInterface'=G},'ls_MessageParser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:45
'get_val_internal'(#state{'ls_ls_ImageAnalyserInterface'=G},'ls_ls_ImageAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:46
'get_val_internal'(#state{'ls_ImageAnalyserInterface'=G},'ls_ImageAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:47
...
'get_val_internal'(#state{'ls_ls_TextAnalyser_LoadBalancerInterface'=G},'ls_ls_TextAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:50
'get_val_internal'(#state{'ls_TextAnalyser_LoadBalancerInterface'=G},'ls_TextAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:51
...
'get_val_internal'(#state{'ls_ls_HeaderAnalyserInterface'=G},'ls_ls_HeaderAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:54
'get_val_internal'(#state{'ls_HeaderAnalyserInterface'=G},'ls_HeaderAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:55
'get_val_internal'(#state{'ls_ls_MessageAnalyserInterface'=G},'ls_ls_MessageAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:56
'get_val_internal'(#state{'ls_MessageAnalyserInterface'=G},'ls_MessageAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:57
'get_val_internal'(#state{'ls_ls_MessageParserInterface'=G},'ls_ls_MessageParserInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:58
'get_val_internal'(#state{'ls_MessageParserInterface'=G},'ls_MessageParserInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:59
'get_val_internal'(#state{'ls_ls_ImageAnalyser_LoadBalancerInterface'=G},'ls_ls_ImageAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:60
'get_val_internal'(#state{'ls_ImageAnalyser_LoadBalancerInterface'=G},'ls_ImageAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:61
'get_val_internal'(#state{'ls_ls_LinkAnalyser_LoadBalancerInterface'=G},'ls_ls_LinkAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:62
'get_val_internal'(#state{'ls_LinkAnalyser_LoadBalancerInterface'=G},'ls_LinkAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/invariants.abs:63
...
'init'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},[P_cloudProvider,P_dbObj,Stack])->
    ...
    T_1,
     %% timesmartdel-orchs/invariants.abs:75--82
    ...
    T_2,
     %% timesmartdel-orchs/invariants.abs:83--90
    ...
    T_3,
     %% timesmartdel-orchs/invariants.abs:91--98
...
'm_getDeploymentComponent'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
 ...
 %% timesmartdel-orchs/invariants.abs:119
 %% timesmartdel-orchs/invariants.abs:119
'm_deploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/invariants.abs:120--120
        put(this, C:set_val_internal(get(this), 'ls_ls_HeaderAnalyser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_HeaderAnalyser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_HeaderAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:121--121
        put(this, C:set_val_internal(get(this), 'ls_HeaderAnalyser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/invariants.abs:122--122
        put(this, C:set_val_internal(get(this), 'ls_ls_TextAnalyserInterface',[C:get_val_internal(get(this), 'ls_TextAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_TextAnalyserInterface')])),
         %% timesmartdel-orchs/invariants.abs:123--123
        put(this, C:set_val_internal(get(this), 'ls_TextAnalyserInterface',[])),
         %% timesmartdel-orchs/invariants.abs:124--124
        put(this, C:set_val_internal(get(this), 'ls_ls_VirusScanner_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_VirusScanner_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_VirusScanner_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:125--125
        put(this, C:set_val_internal(get(this), 'ls_VirusScanner_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/invariants.abs:126--126
        put(this, C:set_val_internal(get(this), 'ls_ls_MessageAnalyser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_MessageAnalyser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_MessageAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:127--127
        put(this, C:set_val_internal(get(this), 'ls_MessageAnalyser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/invariants.abs:128--128
        put(this, C:set_val_internal(get(this), 'ls_ls_AttachmentsManager_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_AttachmentsManager_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_AttachmentsManager_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:129--129
        put(this, C:set_val_internal(get(this), 'ls_AttachmentsManager_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/invariants.abs:130--130
        put(this, C:set_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface',[C:get_val_internal(get(this), 'ls_AttachmentsManagerInterface') | C:get_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface')])),
         %% timesmartdel-orchs/invariants.abs:131--131
        put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',[])),
         %% timesmartdel-orchs/invariants.abs:132--132
        put(this, C:set_val_internal(get(this), 'ls_ls_MessageParser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_MessageParser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_MessageParser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:133--133
        put(this, C:set_val_internal(get(this), 'ls_MessageParser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/invariants.abs:134--134
        put(this, C:set_val_internal(get(this), 'ls_ls_ImageAnalyserInterface',[C:get_val_internal(get(this), 'ls_ImageAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_ImageAnalyserInterface')])),
         %% timesmartdel-orchs/invariants.abs:135--135
        put(this, C:set_val_internal(get(this), 'ls_ImageAnalyserInterface',[])),
         %% timesmartdel-orchs/invariants.abs:136--136
        put(this, C:set_val_internal(get(this), 'ls_ls_VirusScannerInterface',[C:get_val_internal(get(this), 'ls_VirusScannerInterface') | C:get_val_internal(get(this), 'ls_ls_VirusScannerInterface')])),
         %% timesmartdel-orchs/invariants.abs:137--137
        put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',[])),
         %% timesmartdel-orchs/invariants.abs:138--138
        put(this, C:set_val_internal(get(this), 'ls_ls_TextAnalyser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_TextAnalyser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_TextAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:139--139
        put(this, C:set_val_internal(get(this), 'ls_TextAnalyser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/invariants.abs:140--140
        put(this, C:set_val_internal(get(this), 'ls_ls_LinkAnalyserInterface',[C:get_val_internal(get(this), 'ls_LinkAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_LinkAnalyserInterface')])),
         %% timesmartdel-orchs/invariants.abs:141--141
        put(this, C:set_val_internal(get(this), 'ls_LinkAnalyserInterface',[])),
         %% timesmartdel-orchs/invariants.abs:142--142
        put(this, C:set_val_internal(get(this), 'ls_ls_HeaderAnalyserInterface',[C:get_val_internal(get(this), 'ls_HeaderAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_HeaderAnalyserInterface')])),
         %% timesmartdel-orchs/invariants.abs:143--143
        put(this, C:set_val_internal(get(this), 'ls_HeaderAnalyserInterface',[])),
         %% timesmartdel-orchs/invariants.abs:144--144
        put(this, C:set_val_internal(get(this), 'ls_ls_MessageAnalyserInterface',[C:get_val_internal(get(this), 'ls_MessageAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_MessageAnalyserInterface')])),
         %% timesmartdel-orchs/invariants.abs:145--145
        put(this, C:set_val_internal(get(this), 'ls_MessageAnalyserInterface',[])),
         %% timesmartdel-orchs/invariants.abs:146--146
        put(this, C:set_val_internal(get(this), 'ls_ls_MessageParserInterface',[C:get_val_internal(get(this), 'ls_MessageParserInterface') | C:get_val_internal(get(this), 'ls_ls_MessageParserInterface')])),
         %% timesmartdel-orchs/invariants.abs:147--147
        put(this, C:set_val_internal(get(this), 'ls_MessageParserInterface',[])),
         %% timesmartdel-orchs/invariants.abs:148--148
        put(this, C:set_val_internal(get(this), 'ls_ls_ImageAnalyser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_ImageAnalyser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_ImageAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:149--149
        put(this, C:set_val_internal(get(this), 'ls_ImageAnalyser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/invariants.abs:150--150
        put(this, C:set_val_internal(get(this), 'ls_ls_LinkAnalyser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_LinkAnalyser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_LinkAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:151--151
        put(this, C:set_val_internal(get(this), 'ls_LinkAnalyser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/invariants.abs:152--152
        put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',[C:get_val_internal(get(this), 'ls_DeploymentComponent') | C:get_val_internal(get(this), 'ls_ls_DeploymentComponent')])),
         %% timesmartdel-orchs/invariants.abs:153--153
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[])),
         %% timesmartdel-orchs/invariants.abs:154--154
        T_1 = (fun() -> case O of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
...
'm_undeploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        case (not cmp:eq(C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[])) of
            ...
            T_1,
             %% timesmartdel-orchs/invariants.abs:160--160
            put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:161--161
            put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:162--162
            put(this, C:set_val_internal(get(this), 'ls_HeaderAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_HeaderAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:163--163
            put(this, C:set_val_internal(get(this), 'ls_TextAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_TextAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:164--164
            put(this, C:set_val_internal(get(this), 'ls_VirusScanner_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_VirusScanner_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:165--165
            put(this, C:set_val_internal(get(this), 'ls_MessageAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_MessageAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:166--166
            put(this, C:set_val_internal(get(this), 'ls_AttachmentsManager_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_AttachmentsManager_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:167--167
            put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:168--168
            put(this, C:set_val_internal(get(this), 'ls_MessageParser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_MessageParser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:169--169
            put(this, C:set_val_internal(get(this), 'ls_ImageAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_ImageAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:170--170
            put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_VirusScannerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:171--171
            put(this, C:set_val_internal(get(this), 'ls_TextAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_TextAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:172--172
            put(this, C:set_val_internal(get(this), 'ls_LinkAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_LinkAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:173--173
            put(this, C:set_val_internal(get(this), 'ls_HeaderAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_HeaderAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:174--174
            put(this, C:set_val_internal(get(this), 'ls_MessageAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_MessageAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:175--175
            put(this, C:set_val_internal(get(this), 'ls_MessageParserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_MessageParserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:176--176
            put(this, C:set_val_internal(get(this), 'ls_ImageAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_ImageAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:177--177
            put(this, C:set_val_internal(get(this), 'ls_LinkAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_LinkAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:178--178
            put(this, C:set_val_internal(get(this), 'ls_ls_HeaderAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_HeaderAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:179--179
            put(this, C:set_val_internal(get(this), 'ls_ls_TextAnalyserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_TextAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:180--180
            put(this, C:set_val_internal(get(this), 'ls_ls_VirusScanner_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_VirusScanner_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:181--181
            put(this, C:set_val_internal(get(this), 'ls_ls_MessageAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_MessageAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:182--182
            put(this, C:set_val_internal(get(this), 'ls_ls_AttachmentsManager_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_AttachmentsManager_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:183--183
            put(this, C:set_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:184--184
            put(this, C:set_val_internal(get(this), 'ls_ls_MessageParser_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_MessageParser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:185--185
            put(this, C:set_val_internal(get(this), 'ls_ls_ImageAnalyserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_ImageAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:186--186
            put(this, C:set_val_internal(get(this), 'ls_ls_VirusScannerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_VirusScannerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:187--187
            put(this, C:set_val_internal(get(this), 'ls_ls_TextAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_TextAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:188--188
            put(this, C:set_val_internal(get(this), 'ls_ls_LinkAnalyserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_LinkAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:189--189
            put(this, C:set_val_internal(get(this), 'ls_ls_HeaderAnalyserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_HeaderAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:190--190
            put(this, C:set_val_internal(get(this), 'ls_ls_MessageAnalyserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_MessageAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:191--191
            put(this, C:set_val_internal(get(this), 'ls_ls_MessageParserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_MessageParserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:192--192
            put(this, C:set_val_internal(get(this), 'ls_ls_ImageAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_ImageAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/invariants.abs:193--193
...
'm_deploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(vars, (get(vars))#{'c4_large_1' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/invariants.abs:201--201
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_1', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/invariants.abs:202--202
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_1', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:203--203
        put(vars, (get(vars))#{'c4_large_0' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/invariants.abs:204--204
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/invariants.abs:205--205
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:206--206
        put(vars, (get(vars))#{'c4_large_3' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/invariants.abs:207--207
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_3', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/invariants.abs:208--208
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_3', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:209--209
        put(vars, (get(vars))#{'c4_large_2' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/invariants.abs:210--210
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_2', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/invariants.abs:211--211
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_2', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:212--212
        put(vars, (get(vars))#{'c4_large_5' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/invariants.abs:213--213
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_5', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/invariants.abs:214--214
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_5', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:215--215
        put(vars, (get(vars))#{'c4_large_4' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/invariants.abs:216--216
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_4', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/invariants.abs:217--217
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_4', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:218--218
        put(vars, (get(vars))#{'c4_large_7' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/invariants.abs:219--219
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_7', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/invariants.abs:220--220
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_7', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:221--221
        put(vars, (get(vars))#{'c4_large_6' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/invariants.abs:222--222
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_6', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/invariants.abs:223--223
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_6', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:224--224
        put(vars, (get(vars))#{'odefault___VirusScanner_LoadBalancer_0_c4_large_7' => object:new(cog:start(Cog,maps:get('c4_large_7', get(vars))),class_Architecture_VirusScanner_LoadBalancer,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:225--225
        put(vars, (get(vars))#{'coreRequired_odefault___VirusScanner_LoadBalancer_0_c4_large_7' => 2}),
         %% timesmartdel-orchs/invariants.abs:226--226
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_7', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_7', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___VirusScanner_LoadBalancer_0_c4_large_7', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:227--227
        put(this, C:set_val_internal(get(this), 'ls_VirusScanner_LoadBalancerInterface',[maps:get('odefault___VirusScanner_LoadBalancer_0_c4_large_7', get(vars)) | C:get_val_internal(get(this), 'ls_VirusScanner_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:228--228
        put(vars, (get(vars))#{'odefault___MessageParser_LoadBalancer_0_c4_large_3' => object:new(cog:start(Cog,maps:get('c4_large_3', get(vars))),class_Architecture_MessageParser_LoadBalancer,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:229--229
        put(vars, (get(vars))#{'coreRequired_odefault___MessageParser_LoadBalancer_0_c4_large_3' => 2}),
         %% timesmartdel-orchs/invariants.abs:230--230
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_3', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_3', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___MessageParser_LoadBalancer_0_c4_large_3', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:231--231
        put(this, C:set_val_internal(get(this), 'ls_MessageParser_LoadBalancerInterface',[maps:get('odefault___MessageParser_LoadBalancer_0_c4_large_3', get(vars)) | C:get_val_internal(get(this), 'ls_MessageParser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:232--232
        put(vars, (get(vars))#{'odefault___ImageAnalyser_LoadBalancer_0_c4_large_2' => object:new(cog:start(Cog,maps:get('c4_large_2', get(vars))),class_Architecture_ImageAnalyser_LoadBalancer,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:233--233
        put(vars, (get(vars))#{'coreRequired_odefault___ImageAnalyser_LoadBalancer_0_c4_large_2' => 2}),
         %% timesmartdel-orchs/invariants.abs:234--234
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_2', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_2', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___ImageAnalyser_LoadBalancer_0_c4_large_2', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:235--235
        put(this, C:set_val_internal(get(this), 'ls_ImageAnalyser_LoadBalancerInterface',[maps:get('odefault___ImageAnalyser_LoadBalancer_0_c4_large_2', get(vars)) | C:get_val_internal(get(this), 'ls_ImageAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:236--236
        put(vars, (get(vars))#{'odefault___LinkAnalyser_LoadBalancer_0_c4_large_4' => object:new(cog:start(Cog,maps:get('c4_large_4', get(vars))),class_Architecture_LinkAnalyser_LoadBalancer,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:237--237
        put(vars, (get(vars))#{'coreRequired_odefault___LinkAnalyser_LoadBalancer_0_c4_large_4' => 2}),
         %% timesmartdel-orchs/invariants.abs:238--238
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_4', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_4', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___LinkAnalyser_LoadBalancer_0_c4_large_4', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:239--239
        put(this, C:set_val_internal(get(this), 'ls_LinkAnalyser_LoadBalancerInterface',[maps:get('odefault___LinkAnalyser_LoadBalancer_0_c4_large_4', get(vars)) | C:get_val_internal(get(this), 'ls_LinkAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:240--240
        put(vars, (get(vars))#{'odefault___MessageAnalyser_LoadBalancer_0_c4_large_6' => object:new(cog:start(Cog,maps:get('c4_large_6', get(vars))),class_Architecture_MessageAnalyser_LoadBalancer,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:241--241
        put(vars, (get(vars))#{'coreRequired_odefault___MessageAnalyser_LoadBalancer_0_c4_large_6' => 2}),
         %% timesmartdel-orchs/invariants.abs:242--242
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_6', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_6', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___MessageAnalyser_LoadBalancer_0_c4_large_6', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:243--243
        put(this, C:set_val_internal(get(this), 'ls_MessageAnalyser_LoadBalancerInterface',[maps:get('odefault___MessageAnalyser_LoadBalancer_0_c4_large_6', get(vars)) | C:get_val_internal(get(this), 'ls_MessageAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:244--244
        put(vars, (get(vars))#{'odefault___HeaderAnalyser_LoadBalancer_0_c4_large_0' => object:new(cog:start(Cog,maps:get('c4_large_0', get(vars))),class_Architecture_HeaderAnalyser_LoadBalancer,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:245--245
        put(vars, (get(vars))#{'coreRequired_odefault___HeaderAnalyser_LoadBalancer_0_c4_large_0' => 2}),
         %% timesmartdel-orchs/invariants.abs:246--246
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___HeaderAnalyser_LoadBalancer_0_c4_large_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:247--247
        put(this, C:set_val_internal(get(this), 'ls_HeaderAnalyser_LoadBalancerInterface',[maps:get('odefault___HeaderAnalyser_LoadBalancer_0_c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_HeaderAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:248--248
        put(vars, (get(vars))#{'odefault___AttachmentsManager_LoadBalancer_0_c4_large_5' => object:new(cog:start(Cog,maps:get('c4_large_5', get(vars))),class_Architecture_AttachmentsManager_LoadBalancer,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:249--249
        put(vars, (get(vars))#{'coreRequired_odefault___AttachmentsManager_LoadBalancer_0_c4_large_5' => 2}),
         %% timesmartdel-orchs/invariants.abs:250--250
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_5', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_5', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___AttachmentsManager_LoadBalancer_0_c4_large_5', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:251--251
        put(this, C:set_val_internal(get(this), 'ls_AttachmentsManager_LoadBalancerInterface',[maps:get('odefault___AttachmentsManager_LoadBalancer_0_c4_large_5', get(vars)) | C:get_val_internal(get(this), 'ls_AttachmentsManager_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:252--252
        put(vars, (get(vars))#{'odefault___TextAnalyser_LoadBalancer_0_c4_large_1' => object:new(cog:start(Cog,maps:get('c4_large_1', get(vars))),class_Architecture_TextAnalyser_LoadBalancer,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:253--253
        put(vars, (get(vars))#{'coreRequired_odefault___TextAnalyser_LoadBalancer_0_c4_large_1' => 2}),
         %% timesmartdel-orchs/invariants.abs:254--254
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_1', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_1', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___TextAnalyser_LoadBalancer_0_c4_large_1', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:255--255
        put(this, C:set_val_internal(get(this), 'ls_TextAnalyser_LoadBalancerInterface',[maps:get('odefault___TextAnalyser_LoadBalancer_0_c4_large_1', get(vars)) | C:get_val_internal(get(this), 'ls_TextAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/invariants.abs:256--256
        ...
        T_1,
         %% timesmartdel-orchs/invariants.abs:257--257
 ...
 %% timesmartdel-orchs/invariants.abs:260
 %% timesmartdel-orchs/invariants.abs:260
'm_undeploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/invariants.abs:261--261
        put(vars, (get(vars))#{'odefault___VirusScanner_LoadBalancer_0_c4_large_7' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_VirusScanner_LoadBalancerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:262--262
        put(vars, (get(vars))#{'odefault___MessageParser_LoadBalancer_0_c4_large_3' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_MessageParser_LoadBalancerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:263--263
        put(vars, (get(vars))#{'odefault___ImageAnalyser_LoadBalancer_0_c4_large_2' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_ImageAnalyser_LoadBalancerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:264--264
        put(vars, (get(vars))#{'odefault___LinkAnalyser_LoadBalancer_0_c4_large_4' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_LinkAnalyser_LoadBalancerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:265--265
        put(vars, (get(vars))#{'odefault___MessageAnalyser_LoadBalancer_0_c4_large_6' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_MessageAnalyser_LoadBalancerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:266--266
        put(vars, (get(vars))#{'odefault___HeaderAnalyser_LoadBalancer_0_c4_large_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_HeaderAnalyser_LoadBalancerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:267--267
        put(vars, (get(vars))#{'odefault___AttachmentsManager_LoadBalancer_0_c4_large_5' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_AttachmentsManager_LoadBalancerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:268--268
        put(vars, (get(vars))#{'odefault___TextAnalyser_LoadBalancer_0_c4_large_1' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_TextAnalyser_LoadBalancerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:269--269
        []=(fun Loop ([])->
            ...
            true -> receive
                 ...
                 %% timesmartdel-orchs/invariants.abs:270--270
                T_1 = (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
                    null -> throw(dataNullPointerException);
                    Callee=#object{oid=Oid,cog=Cog} ->
                        %% self-call
                ...
                T_1,
                 %% timesmartdel-orchs/invariants.abs:271--271
 ...
 %% timesmartdel-orchs/invariants.abs:275
 %% timesmartdel-orchs/invariants.abs:275
'm_patchSpeed'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_dcs_0,Stack)->
 ...
 'dcs' => V_dcs_0 }),
    try
         %% timesmartdel-orchs/invariants.abs:276--289
        put(vars, (get(vars))#{'tmp1761307678' => m_ABS_StdLib_funs:f_entries(Cog,maps:get('dcs', get(vars)),[O,DC| Stack])}),
         %% timesmartdel-orchs/invariants.abs:276--289
        []=(fun Loop ([])->
            case not (m_ABS_StdLib_funs:f_isEmpty(Cog,maps:get('tmp1761307678', get(vars)),[O,DC| Stack])) of
            false -> [];
            true -> receive
                    {stop_world, CogRef} ->
                        cog:task_is_blocked_for_gc(Cog, self(), get(task_info), get(this)),
                 ...
                 %% timesmartdel-orchs/invariants.abs:276--289
                put(vars, (get(vars))#{'entry' => m_ABS_StdLib_funs:f_head(Cog,maps:get('tmp1761307678', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/invariants.abs:276--289
                put(vars, (get(vars))#{'tmp1761307678' := m_ABS_StdLib_funs:f_tail(Cog,maps:get('tmp1761307678', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/invariants.abs:277--277
                put(vars, (get(vars))#{'dc' => m_ABS_StdLib_funs:f_fst(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/invariants.abs:278--278
                put(vars, (get(vars))#{'coreUsed' => m_ABS_StdLib_funs:f_snd(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/invariants.abs:279--279
                put(vars, (get(vars))#{'tmp1021710315' => cog:create_task(maps:get('dc', get(vars)),'m_total',[dataSpeed,[]],#task_info{method= <<"total"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                 %% timesmartdel-orchs/invariants.abs:279--279
                future:await(maps:get('tmp1021710315', get(vars)), Cog, [O,DC| Stack]),
                ok,
                 %% timesmartdel-orchs/invariants.abs:279--279
                put(vars, (get(vars))#{'speed_aux' => future:get_blocking(maps:get('tmp1021710315', get(vars)), Cog, [O,DC| Stack])}),
                 %% timesmartdel-orchs/invariants.abs:280--283
                put(vars, (get(vars))#{'total_speed' => begin
                 ...
                 %% timesmartdel-orchs/invariants.abs:284--284
                case (not cmp:eq(maps:get('total_speed', get(vars)),-1)) of
                    true ->  %% timesmartdel-orchs/invariants.abs:285--285
                    put(vars, (get(vars))#{'tmp1643298618' => cog:create_task(maps:get('dc', get(vars)),'m_getNumberOfCores',[[]],#task_info{method= <<"getNumberOfCores"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                     %% timesmartdel-orchs/invariants.abs:285--285
                    future:await(maps:get('tmp1643298618', get(vars)), Cog, [O,DC| Stack]),
                    ok,
                     %% timesmartdel-orchs/invariants.abs:285--285
                    put(vars, (get(vars))#{'totalCore' => future:get_blocking(maps:get('tmp1643298618', get(vars)), Cog, [O,DC| Stack])}),
                     %% timesmartdel-orchs/invariants.abs:286--286
                    put(vars, (get(vars))#{'speedPerCore' =>  rationals:rdiv(maps:get('total_speed', get(vars)),maps:get('totalCore', get(vars))) }),
                     %% timesmartdel-orchs/invariants.abs:287--287
