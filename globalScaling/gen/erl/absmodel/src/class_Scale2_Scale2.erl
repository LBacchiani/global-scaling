...
'get_val_internal'(#state{'dbObj'=G},'dbObj')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:32
'get_val_internal'(#state{'ls_ls_HeaderAnalyser_LoadBalancerInterface'=G},'ls_ls_HeaderAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:33
'get_val_internal'(#state{'ls_HeaderAnalyser_LoadBalancerInterface'=G},'ls_HeaderAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:34
...
'get_val_internal'(#state{'ls_ls_VirusScanner_LoadBalancerInterface'=G},'ls_ls_VirusScanner_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:37
'get_val_internal'(#state{'ls_VirusScanner_LoadBalancerInterface'=G},'ls_VirusScanner_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:38
'get_val_internal'(#state{'ls_ls_MessageAnalyser_LoadBalancerInterface'=G},'ls_ls_MessageAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:39
'get_val_internal'(#state{'ls_MessageAnalyser_LoadBalancerInterface'=G},'ls_MessageAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:40
'get_val_internal'(#state{'ls_ls_AttachmentsManager_LoadBalancerInterface'=G},'ls_ls_AttachmentsManager_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:41
'get_val_internal'(#state{'ls_AttachmentsManager_LoadBalancerInterface'=G},'ls_AttachmentsManager_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:42
'get_val_internal'(#state{'ls_ls_AttachmentsManagerInterface'=G},'ls_ls_AttachmentsManagerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:43
'get_val_internal'(#state{'ls_AttachmentsManagerInterface'=G},'ls_AttachmentsManagerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:44
'get_val_internal'(#state{'ls_ls_MessageParser_LoadBalancerInterface'=G},'ls_ls_MessageParser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:45
'get_val_internal'(#state{'ls_MessageParser_LoadBalancerInterface'=G},'ls_MessageParser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:46
'get_val_internal'(#state{'ls_ls_ImageAnalyserInterface'=G},'ls_ls_ImageAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:47
'get_val_internal'(#state{'ls_ImageAnalyserInterface'=G},'ls_ImageAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:48
...
'get_val_internal'(#state{'ls_ls_TextAnalyser_LoadBalancerInterface'=G},'ls_ls_TextAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:51
'get_val_internal'(#state{'ls_TextAnalyser_LoadBalancerInterface'=G},'ls_TextAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:52
...
'get_val_internal'(#state{'ls_ls_HeaderAnalyserInterface'=G},'ls_ls_HeaderAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:55
'get_val_internal'(#state{'ls_HeaderAnalyserInterface'=G},'ls_HeaderAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:56
'get_val_internal'(#state{'ls_ls_MessageAnalyserInterface'=G},'ls_ls_MessageAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:57
'get_val_internal'(#state{'ls_MessageAnalyserInterface'=G},'ls_MessageAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:58
'get_val_internal'(#state{'ls_ls_MessageParserInterface'=G},'ls_ls_MessageParserInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:59
'get_val_internal'(#state{'ls_MessageParserInterface'=G},'ls_MessageParserInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:60
'get_val_internal'(#state{'ls_ls_ImageAnalyser_LoadBalancerInterface'=G},'ls_ls_ImageAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:61
'get_val_internal'(#state{'ls_ImageAnalyser_LoadBalancerInterface'=G},'ls_ImageAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:62
'get_val_internal'(#state{'ls_ls_LinkAnalyser_LoadBalancerInterface'=G},'ls_ls_LinkAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:63
'get_val_internal'(#state{'ls_LinkAnalyser_LoadBalancerInterface'=G},'ls_LinkAnalyser_LoadBalancerInterface')->
    ...
    G;
 %% timesmartdel-orchs/Scale2.abs:64
...
'init'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},[P_cloudProvider,P_messageParser_LoadBalancerObj,P_headerAnalyser_LoadBalancerObj,P_linkAnalyser_LoadBalancerObj,P_textAnalyser_LoadBalancerObj,P_virusScanner_LoadBalancerObj,P_attachmentsManager_LoadBalancerObj,P_imageAnalyser_LoadBalancerObj,P_messageAnalyser_LoadBalancerObj,P_dbObj,Stack])->
    ...
    T_1,
     %% timesmartdel-orchs/Scale2.abs:76--83
    ...
    T_2,
     %% timesmartdel-orchs/Scale2.abs:84--91
    ...
    T_3,
     %% timesmartdel-orchs/Scale2.abs:92--99
...
'm_getDeploymentComponent'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
 ...
 %% timesmartdel-orchs/Scale2.abs:120
 %% timesmartdel-orchs/Scale2.abs:120
'm_deploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/Scale2.abs:121--121
        put(this, C:set_val_internal(get(this), 'ls_ls_HeaderAnalyser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_HeaderAnalyser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_HeaderAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:122--122
        put(this, C:set_val_internal(get(this), 'ls_HeaderAnalyser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:123--123
        put(this, C:set_val_internal(get(this), 'ls_ls_TextAnalyserInterface',[C:get_val_internal(get(this), 'ls_TextAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_TextAnalyserInterface')])),
         %% timesmartdel-orchs/Scale2.abs:124--124
        put(this, C:set_val_internal(get(this), 'ls_TextAnalyserInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:125--125
        put(this, C:set_val_internal(get(this), 'ls_ls_VirusScanner_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_VirusScanner_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_VirusScanner_LoadBalancerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:126--126
        put(this, C:set_val_internal(get(this), 'ls_VirusScanner_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:127--127
        put(this, C:set_val_internal(get(this), 'ls_ls_MessageAnalyser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_MessageAnalyser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_MessageAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:128--128
        put(this, C:set_val_internal(get(this), 'ls_MessageAnalyser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:129--129
        put(this, C:set_val_internal(get(this), 'ls_ls_AttachmentsManager_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_AttachmentsManager_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_AttachmentsManager_LoadBalancerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:130--130
        put(this, C:set_val_internal(get(this), 'ls_AttachmentsManager_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:131--131
        put(this, C:set_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface',[C:get_val_internal(get(this), 'ls_AttachmentsManagerInterface') | C:get_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:132--132
        put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:133--133
        put(this, C:set_val_internal(get(this), 'ls_ls_MessageParser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_MessageParser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_MessageParser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:134--134
        put(this, C:set_val_internal(get(this), 'ls_MessageParser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:135--135
        put(this, C:set_val_internal(get(this), 'ls_ls_ImageAnalyserInterface',[C:get_val_internal(get(this), 'ls_ImageAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_ImageAnalyserInterface')])),
         %% timesmartdel-orchs/Scale2.abs:136--136
        put(this, C:set_val_internal(get(this), 'ls_ImageAnalyserInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:137--137
        put(this, C:set_val_internal(get(this), 'ls_ls_VirusScannerInterface',[C:get_val_internal(get(this), 'ls_VirusScannerInterface') | C:get_val_internal(get(this), 'ls_ls_VirusScannerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:138--138
        put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:139--139
        put(this, C:set_val_internal(get(this), 'ls_ls_TextAnalyser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_TextAnalyser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_TextAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:140--140
        put(this, C:set_val_internal(get(this), 'ls_TextAnalyser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:141--141
        put(this, C:set_val_internal(get(this), 'ls_ls_LinkAnalyserInterface',[C:get_val_internal(get(this), 'ls_LinkAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_LinkAnalyserInterface')])),
         %% timesmartdel-orchs/Scale2.abs:142--142
        put(this, C:set_val_internal(get(this), 'ls_LinkAnalyserInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:143--143
        put(this, C:set_val_internal(get(this), 'ls_ls_HeaderAnalyserInterface',[C:get_val_internal(get(this), 'ls_HeaderAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_HeaderAnalyserInterface')])),
         %% timesmartdel-orchs/Scale2.abs:144--144
        put(this, C:set_val_internal(get(this), 'ls_HeaderAnalyserInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:145--145
        put(this, C:set_val_internal(get(this), 'ls_ls_MessageAnalyserInterface',[C:get_val_internal(get(this), 'ls_MessageAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_MessageAnalyserInterface')])),
         %% timesmartdel-orchs/Scale2.abs:146--146
        put(this, C:set_val_internal(get(this), 'ls_MessageAnalyserInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:147--147
        put(this, C:set_val_internal(get(this), 'ls_ls_MessageParserInterface',[C:get_val_internal(get(this), 'ls_MessageParserInterface') | C:get_val_internal(get(this), 'ls_ls_MessageParserInterface')])),
         %% timesmartdel-orchs/Scale2.abs:148--148
        put(this, C:set_val_internal(get(this), 'ls_MessageParserInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:149--149
        put(this, C:set_val_internal(get(this), 'ls_ls_ImageAnalyser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_ImageAnalyser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_ImageAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:150--150
        put(this, C:set_val_internal(get(this), 'ls_ImageAnalyser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:151--151
        put(this, C:set_val_internal(get(this), 'ls_ls_LinkAnalyser_LoadBalancerInterface',[C:get_val_internal(get(this), 'ls_LinkAnalyser_LoadBalancerInterface') | C:get_val_internal(get(this), 'ls_ls_LinkAnalyser_LoadBalancerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:152--152
        put(this, C:set_val_internal(get(this), 'ls_LinkAnalyser_LoadBalancerInterface',[])),
         %% timesmartdel-orchs/Scale2.abs:153--153
        put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',[C:get_val_internal(get(this), 'ls_DeploymentComponent') | C:get_val_internal(get(this), 'ls_ls_DeploymentComponent')])),
         %% timesmartdel-orchs/Scale2.abs:154--154
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[])),
         %% timesmartdel-orchs/Scale2.abs:155--155
        T_1 = (fun() -> case O of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
...
'm_undeploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        case (not cmp:eq(C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[])) of
            ...
            T_1,
             %% timesmartdel-orchs/Scale2.abs:161--161
            put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:162--162
            put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:163--163
            put(this, C:set_val_internal(get(this), 'ls_HeaderAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_HeaderAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:164--164
            put(this, C:set_val_internal(get(this), 'ls_TextAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_TextAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:165--165
            put(this, C:set_val_internal(get(this), 'ls_VirusScanner_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_VirusScanner_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:166--166
            put(this, C:set_val_internal(get(this), 'ls_MessageAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_MessageAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:167--167
            put(this, C:set_val_internal(get(this), 'ls_AttachmentsManager_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_AttachmentsManager_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:168--168
            put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:169--169
            put(this, C:set_val_internal(get(this), 'ls_MessageParser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_MessageParser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:170--170
            put(this, C:set_val_internal(get(this), 'ls_ImageAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_ImageAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:171--171
            put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_VirusScannerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:172--172
            put(this, C:set_val_internal(get(this), 'ls_TextAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_TextAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:173--173
            put(this, C:set_val_internal(get(this), 'ls_LinkAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_LinkAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:174--174
            put(this, C:set_val_internal(get(this), 'ls_HeaderAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_HeaderAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:175--175
            put(this, C:set_val_internal(get(this), 'ls_MessageAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_MessageAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:176--176
            put(this, C:set_val_internal(get(this), 'ls_MessageParserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_MessageParserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:177--177
            put(this, C:set_val_internal(get(this), 'ls_ImageAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_ImageAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:178--178
            put(this, C:set_val_internal(get(this), 'ls_LinkAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_LinkAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:179--179
            put(this, C:set_val_internal(get(this), 'ls_ls_HeaderAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_HeaderAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:180--180
            put(this, C:set_val_internal(get(this), 'ls_ls_TextAnalyserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_TextAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:181--181
            put(this, C:set_val_internal(get(this), 'ls_ls_VirusScanner_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_VirusScanner_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:182--182
            put(this, C:set_val_internal(get(this), 'ls_ls_MessageAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_MessageAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:183--183
            put(this, C:set_val_internal(get(this), 'ls_ls_AttachmentsManager_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_AttachmentsManager_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:184--184
            put(this, C:set_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:185--185
            put(this, C:set_val_internal(get(this), 'ls_ls_MessageParser_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_MessageParser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:186--186
            put(this, C:set_val_internal(get(this), 'ls_ls_ImageAnalyserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_ImageAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:187--187
            put(this, C:set_val_internal(get(this), 'ls_ls_VirusScannerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_VirusScannerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:188--188
            put(this, C:set_val_internal(get(this), 'ls_ls_TextAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_TextAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:189--189
            put(this, C:set_val_internal(get(this), 'ls_ls_LinkAnalyserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_LinkAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:190--190
            put(this, C:set_val_internal(get(this), 'ls_ls_HeaderAnalyserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_HeaderAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:191--191
            put(this, C:set_val_internal(get(this), 'ls_ls_MessageAnalyserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_MessageAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:192--192
            put(this, C:set_val_internal(get(this), 'ls_ls_MessageParserInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_MessageParserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:193--193
            put(this, C:set_val_internal(get(this), 'ls_ls_ImageAnalyser_LoadBalancerInterface',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_ImageAnalyser_LoadBalancerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/Scale2.abs:194--194
...
'm_deploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(vars, (get(vars))#{'c4_xlarge_0' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/Scale2.abs:202--202
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/Scale2.abs:203--203
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_xlarge_0', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:204--204
        put(vars, (get(vars))#{'c4_2xlarge_0' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/Scale2.abs:205--205
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_2xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/Scale2.abs:206--206
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:207--207
        put(vars, (get(vars))#{'odefault___MessageAnalyser_1_c4_2xlarge_0' => object:new(cog:start(Cog,maps:get('c4_2xlarge_0', get(vars))),class_Architecture_MessageAnalyser,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:208--208
        put(vars, (get(vars))#{'coreRequired_odefault___MessageAnalyser_1_c4_2xlarge_0' => 1}),
         %% timesmartdel-orchs/Scale2.abs:209--209
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___MessageAnalyser_1_c4_2xlarge_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:210--210
        put(this, C:set_val_internal(get(this), 'ls_MessageAnalyserInterface',[maps:get('odefault___MessageAnalyser_1_c4_2xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_MessageAnalyserInterface')])),
         %% timesmartdel-orchs/Scale2.abs:211--211
        put(vars, (get(vars))#{'odefault___MessageAnalyser_0_c4_2xlarge_0' => object:new(cog:start(Cog,maps:get('c4_2xlarge_0', get(vars))),class_Architecture_MessageAnalyser,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:212--212
        put(vars, (get(vars))#{'coreRequired_odefault___MessageAnalyser_0_c4_2xlarge_0' => 1}),
         %% timesmartdel-orchs/Scale2.abs:213--213
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___MessageAnalyser_0_c4_2xlarge_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:214--214
        put(this, C:set_val_internal(get(this), 'ls_MessageAnalyserInterface',[maps:get('odefault___MessageAnalyser_0_c4_2xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_MessageAnalyserInterface')])),
         %% timesmartdel-orchs/Scale2.abs:215--215
        put(vars, (get(vars))#{'odefault___ImageAnalyser_0_c4_2xlarge_0' => object:new(cog:start(Cog,maps:get('c4_2xlarge_0', get(vars))),class_Architecture_ImageAnalyser,[C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:216--216
        put(vars, (get(vars))#{'coreRequired_odefault___ImageAnalyser_0_c4_2xlarge_0' => 1}),
         %% timesmartdel-orchs/Scale2.abs:217--217
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___ImageAnalyser_0_c4_2xlarge_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:218--218
        put(this, C:set_val_internal(get(this), 'ls_ImageAnalyserInterface',[maps:get('odefault___ImageAnalyser_0_c4_2xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_ImageAnalyserInterface')])),
         %% timesmartdel-orchs/Scale2.abs:219--219
        put(vars, (get(vars))#{'odefault___AttachmentsManager_0_c4_2xlarge_0' => object:new(cog:start(Cog,maps:get('c4_2xlarge_0', get(vars))),class_Architecture_AttachmentsManager,[C:get_val_internal(get(this), 'imageAnalyser_LoadBalancerObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:220--220
        put(vars, (get(vars))#{'coreRequired_odefault___AttachmentsManager_0_c4_2xlarge_0' => 1}),
         %% timesmartdel-orchs/Scale2.abs:221--221
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___AttachmentsManager_0_c4_2xlarge_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:222--222
        put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',[maps:get('odefault___AttachmentsManager_0_c4_2xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_AttachmentsManagerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:223--223
        put(vars, (get(vars))#{'odefault___VirusScanner_0_c4_2xlarge_0' => object:new(cog:start(Cog,maps:get('c4_2xlarge_0', get(vars))),class_Architecture_VirusScanner,[C:get_val_internal(get(this), 'attachmentsManager_LoadBalancerObj'),C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:224--224
        put(vars, (get(vars))#{'coreRequired_odefault___VirusScanner_0_c4_2xlarge_0' => 4}),
         %% timesmartdel-orchs/Scale2.abs:225--225
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___VirusScanner_0_c4_2xlarge_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:226--226
        put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',[maps:get('odefault___VirusScanner_0_c4_2xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_VirusScannerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:227--227
        put(vars, (get(vars))#{'odefault___VirusScanner_0_c4_xlarge_0' => object:new(cog:start(Cog,maps:get('c4_xlarge_0', get(vars))),class_Architecture_VirusScanner,[C:get_val_internal(get(this), 'attachmentsManager_LoadBalancerObj'),C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:228--228
        put(vars, (get(vars))#{'coreRequired_odefault___VirusScanner_0_c4_xlarge_0' => 4}),
         %% timesmartdel-orchs/Scale2.abs:229--229
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_xlarge_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_xlarge_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___VirusScanner_0_c4_xlarge_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:230--230
        put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',[maps:get('odefault___VirusScanner_0_c4_xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_VirusScannerInterface')])),
         %% timesmartdel-orchs/Scale2.abs:231--231
        ...
        T_1,
         %% timesmartdel-orchs/Scale2.abs:232--232
        ...
        ok,
         %% timesmartdel-orchs/Scale2.abs:233--233
        T_2 = (fun() -> case C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___MessageAnalyser_0_c4_2xlarge_0', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___MessageAnalyser_0_c4_2xlarge_0', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___MessageAnalyser_0_c4_2xlarge_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_2,
         %% timesmartdel-orchs/Scale2.abs:234--234
        T_3 = (fun() -> case C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___MessageAnalyser_1_c4_2xlarge_0', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___MessageAnalyser_1_c4_2xlarge_0', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___MessageAnalyser_1_c4_2xlarge_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_3,
         %% timesmartdel-orchs/Scale2.abs:235--235
        T_4 = (fun() -> case C:get_val_internal(get(this), 'imageAnalyser_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___ImageAnalyser_0_c4_2xlarge_0', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___ImageAnalyser_0_c4_2xlarge_0', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___ImageAnalyser_0_c4_2xlarge_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_4,
         %% timesmartdel-orchs/Scale2.abs:236--236
        T_5 = (fun() -> case C:get_val_internal(get(this), 'attachmentsManager_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___AttachmentsManager_0_c4_2xlarge_0', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___AttachmentsManager_0_c4_2xlarge_0', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___AttachmentsManager_0_c4_2xlarge_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_5,
         %% timesmartdel-orchs/Scale2.abs:237--237
        T_6 = (fun() -> case C:get_val_internal(get(this), 'virusScanner_LoadBalancerObj') of
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___VirusScanner_0_c4_xlarge_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_6,
         %% timesmartdel-orchs/Scale2.abs:238--238
        T_7 = (fun() -> case C:get_val_internal(get(this), 'virusScanner_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___VirusScanner_0_c4_2xlarge_0', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___VirusScanner_0_c4_2xlarge_0', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___VirusScanner_0_c4_2xlarge_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_7,
        dataUnit
 ...
 %% timesmartdel-orchs/Scale2.abs:241
 %% timesmartdel-orchs/Scale2.abs:241
'm_undeploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/Scale2.abs:242--242
        put(vars, (get(vars))#{'odefault___MessageAnalyser_1_c4_2xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_MessageAnalyserInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:243--243
        put(vars, (get(vars))#{'odefault___MessageAnalyser_0_c4_2xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_MessageAnalyserInterface'),1,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:244--244
        put(vars, (get(vars))#{'odefault___ImageAnalyser_0_c4_2xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_ImageAnalyserInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:245--245
        put(vars, (get(vars))#{'odefault___AttachmentsManager_0_c4_2xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_AttachmentsManagerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:246--246
        put(vars, (get(vars))#{'odefault___VirusScanner_0_c4_2xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_VirusScannerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:247--247
        put(vars, (get(vars))#{'odefault___VirusScanner_0_c4_xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_VirusScannerInterface'),1,[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:248--248
        ...
        T_1,
         %% timesmartdel-orchs/Scale2.abs:249--249
        T_2 = (fun() -> case C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
        ...
        T_2,
         %% timesmartdel-orchs/Scale2.abs:250--250
        T_3 = (fun() -> case C:get_val_internal(get(this), 'imageAnalyser_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
        ...
        T_3,
         %% timesmartdel-orchs/Scale2.abs:251--251
        T_4 = (fun() -> case C:get_val_internal(get(this), 'attachmentsManager_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
        ...
        T_4,
         %% timesmartdel-orchs/Scale2.abs:252--252
        ...
        T_5,
         %% timesmartdel-orchs/Scale2.abs:253--253
        T_6 = (fun() -> case C:get_val_internal(get(this), 'virusScanner_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
        ...
        T_6,
         %% timesmartdel-orchs/Scale2.abs:254--254
        []=(fun Loop ([])->
            ...
            true -> receive
                 ...
                 %% timesmartdel-orchs/Scale2.abs:255--255
                T_7 = (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
                    null -> throw(dataNullPointerException);
                    Callee=#object{oid=Oid,cog=Cog} ->
                        %% self-call
                        Vars=get(vars),
                ...
                T_7,
                 %% timesmartdel-orchs/Scale2.abs:256--256
 ...
 %% timesmartdel-orchs/Scale2.abs:260
 %% timesmartdel-orchs/Scale2.abs:260
'm_patchSpeed'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_dcs_0,Stack)->
 ...
 'dcs' => V_dcs_0 }),
    try
         %% timesmartdel-orchs/Scale2.abs:261--274
        put(vars, (get(vars))#{'tmp946556798' => m_ABS_StdLib_funs:f_entries(Cog,maps:get('dcs', get(vars)),[O,DC| Stack])}),
         %% timesmartdel-orchs/Scale2.abs:261--274
        []=(fun Loop ([])->
            case not (m_ABS_StdLib_funs:f_isEmpty(Cog,maps:get('tmp946556798', get(vars)),[O,DC| Stack])) of
            false -> [];
            true -> receive
                    {stop_world, CogRef} ->
                        cog:task_is_blocked_for_gc(Cog, self(), get(task_info), get(this)),
                 ...
                 %% timesmartdel-orchs/Scale2.abs:261--274
                put(vars, (get(vars))#{'entry' => m_ABS_StdLib_funs:f_head(Cog,maps:get('tmp946556798', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/Scale2.abs:261--274
                put(vars, (get(vars))#{'tmp946556798' := m_ABS_StdLib_funs:f_tail(Cog,maps:get('tmp946556798', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/Scale2.abs:262--262
                put(vars, (get(vars))#{'dc' => m_ABS_StdLib_funs:f_fst(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/Scale2.abs:263--263
                put(vars, (get(vars))#{'coreUsed' => m_ABS_StdLib_funs:f_snd(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/Scale2.abs:264--264
                put(vars, (get(vars))#{'tmp1248103221' => cog:create_task(maps:get('dc', get(vars)),'m_total',[dataSpeed,[]],#task_info{method= <<"total"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                 %% timesmartdel-orchs/Scale2.abs:264--264
                future:await(maps:get('tmp1248103221', get(vars)), Cog, [O,DC| Stack]),
                ok,
                 %% timesmartdel-orchs/Scale2.abs:264--264
                put(vars, (get(vars))#{'speed_aux' => future:get_blocking(maps:get('tmp1248103221', get(vars)), Cog, [O,DC| Stack])}),
                 %% timesmartdel-orchs/Scale2.abs:265--268
                put(vars, (get(vars))#{'total_speed' => begin
                 ...
                 %% timesmartdel-orchs/Scale2.abs:269--269
                case (not cmp:eq(maps:get('total_speed', get(vars)),-1)) of
                    true ->  %% timesmartdel-orchs/Scale2.abs:270--270
                    put(vars, (get(vars))#{'tmp1731883050' => cog:create_task(maps:get('dc', get(vars)),'m_getNumberOfCores',[[]],#task_info{method= <<"getNumberOfCores"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                     %% timesmartdel-orchs/Scale2.abs:270--270
                    future:await(maps:get('tmp1731883050', get(vars)), Cog, [O,DC| Stack]),
                    ok,
                     %% timesmartdel-orchs/Scale2.abs:270--270
                    put(vars, (get(vars))#{'totalCore' => future:get_blocking(maps:get('tmp1731883050', get(vars)), Cog, [O,DC| Stack])}),
                     %% timesmartdel-orchs/Scale2.abs:271--271
                    put(vars, (get(vars))#{'speedPerCore' =>  rationals:rdiv(maps:get('total_speed', get(vars)),maps:get('totalCore', get(vars))) }),
                     %% timesmartdel-orchs/Scale2.abs:272--272
