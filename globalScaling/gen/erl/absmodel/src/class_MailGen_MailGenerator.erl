-module(class_MailGen_MailGenerator).
...
-record(state,{'class'=class_MailGen_MailGenerator,'entryPoint'=null}).
'init_internal'()->
    #state{}.
            ...
            true -> receive
                ...
                []=(fun Loop ([])->
                    ...
                    true -> receive
                         ...
                         %% mail_gen.abs:19--19
                        T_1 = cog:create_task(C:get_val_internal(get(this), 'entryPoint'),'m_newRequest',[<<"Message"/utf8>>,[]],#task_info{method= <<"newRequest"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog),
                        T_1,
                         %% mail_gen.abs:20--20
