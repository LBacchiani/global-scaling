-module(class_AttachmentsManagerPlan_AttachmentsManagerPlan).
-include_lib("../include/abs_types.hrl").
-behaviour(object).
-export([get_val_internal/2,set_val_internal/3,init_internal/0,get_state_for_modelapi/1,implemented_interfaces/0,exported/0]).
-compile(export_all).

implemented_interfaces() -> [ <<"Object">>, <<"AttachmentsManagerPlan">> ].

exported() -> #{  }.

%% --- Internal state and low-level accessors

-record(state,{'class'=class_AttachmentsManagerPlan_AttachmentsManagerPlan,'cloudProvider'=null,'attachmentsManager_LoadBalancerObj'=null,'imageAnalyser_LoadBalancerObj'=null,'ls_ls_AttachmentsManagerInterface'=null,'ls_AttachmentsManagerInterface'=null,'ls_ls_DeploymentComponent'=null,'ls_DeploymentComponent'=null,'waiting_time'=null}).
'init_internal'()->
    #state{}.

 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:14
...
'get_val_internal'(#state{'imageAnalyser_LoadBalancerObj'=G},'imageAnalyser_LoadBalancerObj')->
    ...
    G;
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:16
'get_val_internal'(#state{'ls_ls_AttachmentsManagerInterface'=G},'ls_ls_AttachmentsManagerInterface')->
    ...
    G;
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:17
'get_val_internal'(#state{'ls_AttachmentsManagerInterface'=G},'ls_AttachmentsManagerInterface')->
    ...
    G;
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:18
...
'init'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},[P_cloudProvider,P_attachmentsManager_LoadBalancerObj,P_imageAnalyser_LoadBalancerObj,Stack])->
    ...
    T_1,
     %% timesmartdel-orchs/AttachmentsManagerPlan.abs:30--37
    ...
    T_2,
     %% timesmartdel-orchs/AttachmentsManagerPlan.abs:38--45
...
%% --- Methods
 ...
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:48
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:48
'm_getAttachmentsManagerInterface'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:48--48
 ...
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:49
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:49
'm_getDeploymentComponent'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:49--49
 ...
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:51
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:51
'm_deploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:52--52
        put(this, C:set_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface',[C:get_val_internal(get(this), 'ls_AttachmentsManagerInterface') | C:get_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface')])),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:53--53
        put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',[])),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:54--54
        put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',[C:get_val_internal(get(this), 'ls_DeploymentComponent') | C:get_val_internal(get(this), 'ls_ls_DeploymentComponent')])),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:55--55
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[])),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:56--56
        T_1 = (fun() -> case O of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
 ...
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:59
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:59
'm_undeploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:60--60
        case (not cmp:eq(C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[])) of
            true ->  %% timesmartdel-orchs/AttachmentsManagerPlan.abs:61--61
            T_1 = (fun() -> case O of
                null -> throw(dataNullPointerException);
                Callee=#object{oid=Oid,cog=Cog} ->
                    %% self-call
            ...
            T_1,
             %% timesmartdel-orchs/AttachmentsManagerPlan.abs:62--62
            put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/AttachmentsManagerPlan.abs:63--63
            put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/AttachmentsManagerPlan.abs:64--64
            put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/AttachmentsManagerPlan.abs:65--65
 ...
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:70
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:70
'm_deploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:71--71
        put(vars, (get(vars))#{'speedPatchMap' => m_ABS_StdLib_funs:f_map(Cog,[],[O,DC| Stack])}),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:72--72
        put(vars, (get(vars))#{'c4_large_0' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:73--73
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:74--74
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:75--75
        put(vars, (get(vars))#{'odefault___AttachmentsManager_0_c4_large_0' => object:new(cog:start(Cog,maps:get('c4_large_0', get(vars))),class_Architecture_AttachmentsManager,[C:get_val_internal(get(this), 'imageAnalyser_LoadBalancerObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:76--76
        put(vars, (get(vars))#{'coreRequired_odefault___AttachmentsManager_0_c4_large_0' => 1}),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:77--77
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___AttachmentsManager_0_c4_large_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:78--78
        put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',[maps:get('odefault___AttachmentsManager_0_c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_AttachmentsManagerInterface')])),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:79--79
        ...
        T_1,
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:80--80
        ...
        ok,
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:81--81
        T_2 = (fun() -> case C:get_val_internal(get(this), 'attachmentsManager_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
 ...
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:84
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:84
'm_undeploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:85--85
        put(vars, (get(vars))#{'odefault___AttachmentsManager_0_c4_large_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_AttachmentsManagerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:86--86
        T_1 = (fun() -> case C:get_val_internal(get(this), 'attachmentsManager_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
        ...
        T_1,
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:87--87
        []=(fun Loop ([])->
            ...
            true -> receive
                 ...
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:88--88
                T_2 = (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
                    null -> throw(dataNullPointerException);
                    Callee=#object{oid=Oid,cog=Cog} ->
                        %% self-call
                ...
                T_2,
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:89--89
 ...
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:93
 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:93
'm_patchSpeed'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_dcs_0,Stack)->
 ...
 'dcs' => V_dcs_0 }),
    try
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:94--107
        put(vars, (get(vars))#{'tmp1359574272' => m_ABS_StdLib_funs:f_entries(Cog,maps:get('dcs', get(vars)),[O,DC| Stack])}),
         %% timesmartdel-orchs/AttachmentsManagerPlan.abs:94--107
        []=(fun Loop ([])->
            case not (m_ABS_StdLib_funs:f_isEmpty(Cog,maps:get('tmp1359574272', get(vars)),[O,DC| Stack])) of
            false -> [];
            true -> receive
                    {stop_world, CogRef} ->
                        cog:task_is_blocked_for_gc(Cog, self(), get(task_info), get(this)),
                 ...
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:94--107
                put(vars, (get(vars))#{'entry' => m_ABS_StdLib_funs:f_head(Cog,maps:get('tmp1359574272', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:94--107
                put(vars, (get(vars))#{'tmp1359574272' := m_ABS_StdLib_funs:f_tail(Cog,maps:get('tmp1359574272', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:95--95
                put(vars, (get(vars))#{'dc' => m_ABS_StdLib_funs:f_fst(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:96--96
                put(vars, (get(vars))#{'coreUsed' => m_ABS_StdLib_funs:f_snd(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:97--97
                put(vars, (get(vars))#{'tmp239559548' => cog:create_task(maps:get('dc', get(vars)),'m_total',[dataSpeed,[]],#task_info{method= <<"total"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:97--97
                future:await(maps:get('tmp239559548', get(vars)), Cog, [O,DC| Stack]),
                ok,
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:97--97
                put(vars, (get(vars))#{'speed_aux' => future:get_blocking(maps:get('tmp239559548', get(vars)), Cog, [O,DC| Stack])}),
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:98--101
                put(vars, (get(vars))#{'total_speed' => begin
                 ...
                 %% timesmartdel-orchs/AttachmentsManagerPlan.abs:102--102
                case (not cmp:eq(maps:get('total_speed', get(vars)),-1)) of
                    true ->  %% timesmartdel-orchs/AttachmentsManagerPlan.abs:103--103
                    put(vars, (get(vars))#{'tmp1617891184' => cog:create_task(maps:get('dc', get(vars)),'m_getNumberOfCores',[[]],#task_info{method= <<"getNumberOfCores"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                     %% timesmartdel-orchs/AttachmentsManagerPlan.abs:103--103
                    future:await(maps:get('tmp1617891184', get(vars)), Cog, [O,DC| Stack]),
                    ok,
                     %% timesmartdel-orchs/AttachmentsManagerPlan.abs:103--103
                    put(vars, (get(vars))#{'totalCore' => future:get_blocking(maps:get('tmp1617891184', get(vars)), Cog, [O,DC| Stack])}),
                     %% timesmartdel-orchs/AttachmentsManagerPlan.abs:104--104
                    put(vars, (get(vars))#{'speedPerCore' =>  rationals:rdiv(maps:get('total_speed', get(vars)),maps:get('totalCore', get(vars))) }),
                     %% timesmartdel-orchs/AttachmentsManagerPlan.abs:105--105
