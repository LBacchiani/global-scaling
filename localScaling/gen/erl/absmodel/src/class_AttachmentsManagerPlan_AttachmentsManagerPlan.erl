...
implemented_interfaces() -> [ <<"AttachmentsManagerPlan">>, <<"Object">> ].
...
'init'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},[P_cloudProvider,P_attachmentsManager_LoadBalancerObj,P_imageAnalyser_LoadBalancerObj,Stack])->
    ...
    T_1,
     %% AttachmentsManagerPlan.abs:29--36
    ...
    T_2,
     %% AttachmentsManagerPlan.abs:37--44
...
'm_deploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(this, C:set_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface',[C:get_val_internal(get(this), 'ls_AttachmentsManagerInterface') | C:get_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface')])),
         %% AttachmentsManagerPlan.abs:52--52
        put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',[])),
         %% AttachmentsManagerPlan.abs:53--53
        put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',[C:get_val_internal(get(this), 'ls_DeploymentComponent') | C:get_val_internal(get(this), 'ls_ls_DeploymentComponent')])),
         %% AttachmentsManagerPlan.abs:54--54
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[])),
         %% AttachmentsManagerPlan.abs:55--55
        T_1 = (fun() -> case O of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
...
'm_undeploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        case (not cmp:eq(C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[])) of
            ...
            T_1,
             %% AttachmentsManagerPlan.abs:61--61
            put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% AttachmentsManagerPlan.abs:62--62
            put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% AttachmentsManagerPlan.abs:63--63
            put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_AttachmentsManagerInterface'),[O,DC| Stack]))),
             %% AttachmentsManagerPlan.abs:64--64
...
'm_deploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(vars, (get(vars))#{'c4_large_0' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% AttachmentsManagerPlan.abs:72--72
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% AttachmentsManagerPlan.abs:73--73
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),0,[O,DC| Stack])}),
         %% AttachmentsManagerPlan.abs:74--74
        ...
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___AttachmentsManager_0_c4_large_0', get(vars)))) ,[O,DC| Stack])}),
         %% AttachmentsManagerPlan.abs:77--77
        put(this, C:set_val_internal(get(this), 'ls_AttachmentsManagerInterface',[maps:get('odefault___AttachmentsManager_0_c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_AttachmentsManagerInterface')])),
         %% AttachmentsManagerPlan.abs:78--78
        ...
        T_1,
         %% AttachmentsManagerPlan.abs:79--79
        ...
        ok,
         %% AttachmentsManagerPlan.abs:80--80
...
'm_undeploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(vars, (get(vars))#{'odefault___AttachmentsManager_0_c4_large_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_AttachmentsManagerInterface'),0,[O,DC| Stack])}),
         %% AttachmentsManagerPlan.abs:85--85
        ...
        T_1,
         %% AttachmentsManagerPlan.abs:86--86
        []=(fun Loop ([])->
            ...
            true -> receive
                 ...
                 %% AttachmentsManagerPlan.abs:87--87
                T_2 = (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
                    null -> throw(dataNullPointerException);
                    Callee=#object{oid=Oid,cog=Cog} ->
                        %% self-call
                ...
                T_2,
                 %% AttachmentsManagerPlan.abs:88--88
...
'm_patchSpeed'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_dcs_0,Stack)->
 ...
 'dcs' => V_dcs_0 }),
    try
         %% AttachmentsManagerPlan.abs:93--106
        put(vars, (get(vars))#{'tmp2056109041' => m_ABS_StdLib_funs:f_entries(Cog,maps:get('dcs', get(vars)),[O,DC| Stack])}),
         %% AttachmentsManagerPlan.abs:93--106
        []=(fun Loop ([])->
            case not (m_ABS_StdLib_funs:f_isEmpty(Cog,maps:get('tmp2056109041', get(vars)),[O,DC| Stack])) of
            false -> [];
            true -> receive
                    {stop_world, CogRef} ->
                        cog:task_is_blocked_for_gc(Cog, self(), get(task_info), get(this)),
                 ...
                 %% AttachmentsManagerPlan.abs:93--106
                put(vars, (get(vars))#{'entry' => m_ABS_StdLib_funs:f_head(Cog,maps:get('tmp2056109041', get(vars)),[O,DC| Stack])}),
                 %% AttachmentsManagerPlan.abs:93--106
                put(vars, (get(vars))#{'tmp2056109041' := m_ABS_StdLib_funs:f_tail(Cog,maps:get('tmp2056109041', get(vars)),[O,DC| Stack])}),
                 %% AttachmentsManagerPlan.abs:94--94
                put(vars, (get(vars))#{'dc' => m_ABS_StdLib_funs:f_fst(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% AttachmentsManagerPlan.abs:95--95
                put(vars, (get(vars))#{'coreUsed' => m_ABS_StdLib_funs:f_snd(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% AttachmentsManagerPlan.abs:96--96
                put(vars, (get(vars))#{'tmp761970631' => cog:create_task(maps:get('dc', get(vars)),'m_total',[dataSpeed,[]],#task_info{method= <<"total"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog,true)}),
                 %% AttachmentsManagerPlan.abs:96--96
                future:await(maps:get('tmp761970631', get(vars)), Cog, [O,DC| Stack]),
                ok,
                 %% AttachmentsManagerPlan.abs:96--96
                put(vars, (get(vars))#{'speed_aux' => future:get_blocking(maps:get('tmp761970631', get(vars)), Cog, [O,DC| Stack])}),
                 %% AttachmentsManagerPlan.abs:97--100
                put(vars, (get(vars))#{'total_speed' => begin
                 ...
                 %% AttachmentsManagerPlan.abs:101--101
                case (not cmp:eq(maps:get('total_speed', get(vars)),-1)) of
                    true ->  %% AttachmentsManagerPlan.abs:102--102
                    put(vars, (get(vars))#{'tmp1331517564' => cog:create_task(maps:get('dc', get(vars)),'m_getNumberOfCores',[[]],#task_info{method= <<"getNumberOfCores"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog,true)}),
                     %% AttachmentsManagerPlan.abs:102--102
                    future:await(maps:get('tmp1331517564', get(vars)), Cog, [O,DC| Stack]),
                    ok,
                     %% AttachmentsManagerPlan.abs:102--102
                    put(vars, (get(vars))#{'totalCore' => future:get_blocking(maps:get('tmp1331517564', get(vars)), Cog, [O,DC| Stack])}),
                     %% AttachmentsManagerPlan.abs:103--103
                    put(vars, (get(vars))#{'speedPerCore' =>  rationals:rdiv(maps:get('total_speed', get(vars)),maps:get('totalCore', get(vars))) }),
                     %% AttachmentsManagerPlan.abs:104--104
