...
implemented_interfaces() -> [ <<"Object">>, <<"MessageParserPlan">> ].
...
'init_internal'()->
 ...
 %% timesmartdel-orchs/MessageParserPlan.abs:15
...
'get_val_internal'(#state{'messageAnalyser_LoadBalancerObj'=G},'messageAnalyser_LoadBalancerObj')->
    ...
    G;
 %% timesmartdel-orchs/MessageParserPlan.abs:17
'get_val_internal'(#state{'ls_ls_MessageParserInterface'=G},'ls_ls_MessageParserInterface')->
    ...
    G;
 %% timesmartdel-orchs/MessageParserPlan.abs:18
'get_val_internal'(#state{'ls_MessageParserInterface'=G},'ls_MessageParserInterface')->
    ...
    G;
 %% timesmartdel-orchs/MessageParserPlan.abs:19
...
'init'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},[P_cloudProvider,P_messageParser_LoadBalancerObj,P_headerAnalyser_LoadBalancerObj,P_linkAnalyser_LoadBalancerObj,P_textAnalyser_LoadBalancerObj,P_virusScanner_LoadBalancerObj,P_dbObj,P_messageAnalyser_LoadBalancerObj,Stack])->
    ...
    T_1,
     %% timesmartdel-orchs/MessageParserPlan.abs:31--38
    ...
    T_2,
     %% timesmartdel-orchs/MessageParserPlan.abs:39--46
    ...
    T_3,
     %% timesmartdel-orchs/MessageParserPlan.abs:47--54
...
%% --- Methods
 ...
 %% timesmartdel-orchs/MessageParserPlan.abs:57
 %% timesmartdel-orchs/MessageParserPlan.abs:57
'm_getMessageParserInterface'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageParserPlan.abs:57--57
 ...
 %% timesmartdel-orchs/MessageParserPlan.abs:58
 %% timesmartdel-orchs/MessageParserPlan.abs:58
'm_getDeploymentComponent'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageParserPlan.abs:58--58
 ...
 %% timesmartdel-orchs/MessageParserPlan.abs:60
 %% timesmartdel-orchs/MessageParserPlan.abs:60
'm_deploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageParserPlan.abs:61--61
        put(this, C:set_val_internal(get(this), 'ls_ls_MessageParserInterface',[C:get_val_internal(get(this), 'ls_MessageParserInterface') | C:get_val_internal(get(this), 'ls_ls_MessageParserInterface')])),
         %% timesmartdel-orchs/MessageParserPlan.abs:62--62
        put(this, C:set_val_internal(get(this), 'ls_MessageParserInterface',[])),
         %% timesmartdel-orchs/MessageParserPlan.abs:63--63
        put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',[C:get_val_internal(get(this), 'ls_DeploymentComponent') | C:get_val_internal(get(this), 'ls_ls_DeploymentComponent')])),
         %% timesmartdel-orchs/MessageParserPlan.abs:64--64
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[])),
         %% timesmartdel-orchs/MessageParserPlan.abs:65--65
        T_1 = (fun() -> case O of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
 ...
 %% timesmartdel-orchs/MessageParserPlan.abs:68
 %% timesmartdel-orchs/MessageParserPlan.abs:68
'm_undeploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageParserPlan.abs:69--69
        case (not cmp:eq(C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[])) of
            true ->  %% timesmartdel-orchs/MessageParserPlan.abs:70--70
            T_1 = (fun() -> case O of
                null -> throw(dataNullPointerException);
                Callee=#object{oid=Oid,cog=Cog} ->
                    %% self-call
            ...
            T_1,
             %% timesmartdel-orchs/MessageParserPlan.abs:71--71
            put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/MessageParserPlan.abs:72--72
            put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/MessageParserPlan.abs:73--73
            put(this, C:set_val_internal(get(this), 'ls_MessageParserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_MessageParserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/MessageParserPlan.abs:74--74
...
'm_deploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(vars, (get(vars))#{'c4_large_0' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/MessageParserPlan.abs:82--82
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/MessageParserPlan.abs:83--83
        ...
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___MessageParser_0_c4_large_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/MessageParserPlan.abs:87--87
        put(this, C:set_val_internal(get(this), 'ls_MessageParserInterface',[maps:get('odefault___MessageParser_0_c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_MessageParserInterface')])),
         %% timesmartdel-orchs/MessageParserPlan.abs:88--88
        ...
        T_1,
         %% timesmartdel-orchs/MessageParserPlan.abs:89--89
        ...
        ok,
         %% timesmartdel-orchs/MessageParserPlan.abs:90--90
        T_2 = (fun() -> case C:get_val_internal(get(this), 'messageParser_LoadBalancerObj') of
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___MessageParser_0_c4_large_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_2,
        dataUnit
 ...
 %% timesmartdel-orchs/MessageParserPlan.abs:93
 %% timesmartdel-orchs/MessageParserPlan.abs:93
'm_undeploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageParserPlan.abs:94--94
        put(vars, (get(vars))#{'odefault___MessageParser_0_c4_large_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_MessageParserInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/MessageParserPlan.abs:95--95
        ...
        T_1,
         %% timesmartdel-orchs/MessageParserPlan.abs:96--96
        []=(fun Loop ([])->
            ...
            true -> receive
                 ...
                 %% timesmartdel-orchs/MessageParserPlan.abs:97--97
                T_2 = (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
                    null -> throw(dataNullPointerException);
                    Callee=#object{oid=Oid,cog=Cog} ->
                        %% self-call
                ...
                T_2,
                 %% timesmartdel-orchs/MessageParserPlan.abs:98--98
 ...
 %% timesmartdel-orchs/MessageParserPlan.abs:102
 %% timesmartdel-orchs/MessageParserPlan.abs:102
'm_patchSpeed'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_dcs_0,Stack)->
 ...
 'dcs' => V_dcs_0 }),
    try
         %% timesmartdel-orchs/MessageParserPlan.abs:103--116
        put(vars, (get(vars))#{'tmp1179680218' => m_ABS_StdLib_funs:f_entries(Cog,maps:get('dcs', get(vars)),[O,DC| Stack])}),
         %% timesmartdel-orchs/MessageParserPlan.abs:103--116
        []=(fun Loop ([])->
            case not (m_ABS_StdLib_funs:f_isEmpty(Cog,maps:get('tmp1179680218', get(vars)),[O,DC| Stack])) of
            false -> [];
            true -> receive
                    {stop_world, CogRef} ->
                        cog:task_is_blocked_for_gc(Cog, self(), get(task_info), get(this)),
                 ...
                 %% timesmartdel-orchs/MessageParserPlan.abs:103--116
                put(vars, (get(vars))#{'entry' => m_ABS_StdLib_funs:f_head(Cog,maps:get('tmp1179680218', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/MessageParserPlan.abs:103--116
                put(vars, (get(vars))#{'tmp1179680218' := m_ABS_StdLib_funs:f_tail(Cog,maps:get('tmp1179680218', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/MessageParserPlan.abs:104--104
                put(vars, (get(vars))#{'dc' => m_ABS_StdLib_funs:f_fst(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/MessageParserPlan.abs:105--105
                put(vars, (get(vars))#{'coreUsed' => m_ABS_StdLib_funs:f_snd(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/MessageParserPlan.abs:106--106
                put(vars, (get(vars))#{'tmp237279395' => cog:create_task(maps:get('dc', get(vars)),'m_total',[dataSpeed,[]],#task_info{method= <<"total"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                 %% timesmartdel-orchs/MessageParserPlan.abs:106--106
                future:await(maps:get('tmp237279395', get(vars)), Cog, [O,DC| Stack]),
                ok,
                 %% timesmartdel-orchs/MessageParserPlan.abs:106--106
                put(vars, (get(vars))#{'speed_aux' => future:get_blocking(maps:get('tmp237279395', get(vars)), Cog, [O,DC| Stack])}),
                 %% timesmartdel-orchs/MessageParserPlan.abs:107--110
                put(vars, (get(vars))#{'total_speed' => begin
                 ...
                 %% timesmartdel-orchs/MessageParserPlan.abs:111--111
                case (not cmp:eq(maps:get('total_speed', get(vars)),-1)) of
                    true ->  %% timesmartdel-orchs/MessageParserPlan.abs:112--112
                    put(vars, (get(vars))#{'tmp650311527' => cog:create_task(maps:get('dc', get(vars)),'m_getNumberOfCores',[[]],#task_info{method= <<"getNumberOfCores"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                     %% timesmartdel-orchs/MessageParserPlan.abs:112--112
                    future:await(maps:get('tmp650311527', get(vars)), Cog, [O,DC| Stack]),
                    ok,
                     %% timesmartdel-orchs/MessageParserPlan.abs:112--112
                    put(vars, (get(vars))#{'totalCore' => future:get_blocking(maps:get('tmp650311527', get(vars)), Cog, [O,DC| Stack])}),
                     %% timesmartdel-orchs/MessageParserPlan.abs:113--113
                    put(vars, (get(vars))#{'speedPerCore' =>  rationals:rdiv(maps:get('total_speed', get(vars)),maps:get('totalCore', get(vars))) }),
                     %% timesmartdel-orchs/MessageParserPlan.abs:114--114
