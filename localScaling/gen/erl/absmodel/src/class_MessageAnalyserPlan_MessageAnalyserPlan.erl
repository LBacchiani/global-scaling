-module(class_MessageAnalyserPlan_MessageAnalyserPlan).
-include_lib("../include/abs_types.hrl").
-behaviour(object).
-export([get_val_internal/2,set_val_internal/3,init_internal/0,get_state_for_modelapi/1,implemented_interfaces/0,exported/0]).
-compile(export_all).

implemented_interfaces() -> [ <<"MessageAnalyserPlan">>, <<"Object">> ].

exported() -> #{  }.

%% --- Internal state and low-level accessors

-record(state,{'class'=class_MessageAnalyserPlan_MessageAnalyserPlan,'cloudProvider'=null,'messageAnalyser_LoadBalancerObj'=null,'dbObj'=null,'ls_ls_MessageAnalyserInterface'=null,'ls_MessageAnalyserInterface'=null,'ls_ls_DeploymentComponent'=null,'ls_DeploymentComponent'=null,'waiting_time'=null}).
'init_internal'()->
    #state{}.

 %% timesmartdel-orchs/MessageAnalyserPlan.abs:15
...
'get_val_internal'(#state{'dbObj'=G},'dbObj')->
    ...
    G;
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:17
'get_val_internal'(#state{'ls_ls_MessageAnalyserInterface'=G},'ls_ls_MessageAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:18
'get_val_internal'(#state{'ls_MessageAnalyserInterface'=G},'ls_MessageAnalyserInterface')->
    ...
    G;
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:19
...
'init'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},[P_cloudProvider,P_messageAnalyser_LoadBalancerObj,P_dbObj,Stack])->
    ...
    T_1,
     %% timesmartdel-orchs/MessageAnalyserPlan.abs:31--38
    ...
    T_2,
     %% timesmartdel-orchs/MessageAnalyserPlan.abs:39--46
...
%% --- Methods
 ...
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:49
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:49
'm_getMessageAnalyserInterface'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:49--49
 ...
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:50
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:50
'm_getDeploymentComponent'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:50--50
 ...
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:52
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:52
'm_deploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:53--53
        put(this, C:set_val_internal(get(this), 'ls_ls_MessageAnalyserInterface',[C:get_val_internal(get(this), 'ls_MessageAnalyserInterface') | C:get_val_internal(get(this), 'ls_ls_MessageAnalyserInterface')])),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:54--54
        put(this, C:set_val_internal(get(this), 'ls_MessageAnalyserInterface',[])),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:55--55
        put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',[C:get_val_internal(get(this), 'ls_DeploymentComponent') | C:get_val_internal(get(this), 'ls_ls_DeploymentComponent')])),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:56--56
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[])),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:57--57
        T_1 = (fun() -> case O of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
 ...
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:60
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:60
'm_undeploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:61--61
        case (not cmp:eq(C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[])) of
            true ->  %% timesmartdel-orchs/MessageAnalyserPlan.abs:62--62
            T_1 = (fun() -> case O of
                null -> throw(dataNullPointerException);
                Callee=#object{oid=Oid,cog=Cog} ->
                    %% self-call
            ...
            T_1,
             %% timesmartdel-orchs/MessageAnalyserPlan.abs:63--63
            put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/MessageAnalyserPlan.abs:64--64
            put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/MessageAnalyserPlan.abs:65--65
            put(this, C:set_val_internal(get(this), 'ls_MessageAnalyserInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_MessageAnalyserInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/MessageAnalyserPlan.abs:66--66
 ...
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:71
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:71
'm_deploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:72--72
        put(vars, (get(vars))#{'speedPatchMap' => m_ABS_StdLib_funs:f_map(Cog,[],[O,DC| Stack])}),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:73--73
        put(vars, (get(vars))#{'c4_large_0' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:74--74
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:75--75
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:76--76
        put(vars, (get(vars))#{'odefault___MessageAnalyser_0_c4_large_0' => object:new(cog:start(Cog,maps:get('c4_large_0', get(vars))),class_Architecture_MessageAnalyser,[C:get_val_internal(get(this), 'dbObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:77--77
        put(vars, (get(vars))#{'coreRequired_odefault___MessageAnalyser_0_c4_large_0' => 1}),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:78--78
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_large_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___MessageAnalyser_0_c4_large_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:79--79
        put(this, C:set_val_internal(get(this), 'ls_MessageAnalyserInterface',[maps:get('odefault___MessageAnalyser_0_c4_large_0', get(vars)) | C:get_val_internal(get(this), 'ls_MessageAnalyserInterface')])),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:80--80
        ...
        T_1,
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:81--81
        ...
        ok,
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:82--82
        T_2 = (fun() -> case C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___MessageAnalyser_0_c4_large_0', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___MessageAnalyser_0_c4_large_0', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___MessageAnalyser_0_c4_large_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_2,
        dataUnit
 ...
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:85
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:85
'm_undeploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:86--86
        put(vars, (get(vars))#{'odefault___MessageAnalyser_0_c4_large_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_MessageAnalyserInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:87--87
        ...
        T_1,
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:88--88
        []=(fun Loop ([])->
            ...
            true -> receive
                 ...
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:89--89
                T_2 = (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
                    null -> throw(dataNullPointerException);
                    Callee=#object{oid=Oid,cog=Cog} ->
                        %% self-call
                ...
                T_2,
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:90--90
 ...
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:94
 %% timesmartdel-orchs/MessageAnalyserPlan.abs:94
'm_patchSpeed'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_dcs_0,Stack)->
 ...
 'dcs' => V_dcs_0 }),
    try
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:95--108
        put(vars, (get(vars))#{'tmp37639998' => m_ABS_StdLib_funs:f_entries(Cog,maps:get('dcs', get(vars)),[O,DC| Stack])}),
         %% timesmartdel-orchs/MessageAnalyserPlan.abs:95--108
        []=(fun Loop ([])->
            case not (m_ABS_StdLib_funs:f_isEmpty(Cog,maps:get('tmp37639998', get(vars)),[O,DC| Stack])) of
            false -> [];
            true -> receive
                    {stop_world, CogRef} ->
                        cog:task_is_blocked_for_gc(Cog, self(), get(task_info), get(this)),
                 ...
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:95--108
                put(vars, (get(vars))#{'entry' => m_ABS_StdLib_funs:f_head(Cog,maps:get('tmp37639998', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:95--108
                put(vars, (get(vars))#{'tmp37639998' := m_ABS_StdLib_funs:f_tail(Cog,maps:get('tmp37639998', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:96--96
                put(vars, (get(vars))#{'dc' => m_ABS_StdLib_funs:f_fst(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:97--97
                put(vars, (get(vars))#{'coreUsed' => m_ABS_StdLib_funs:f_snd(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:98--98
                put(vars, (get(vars))#{'tmp773610783' => cog:create_task(maps:get('dc', get(vars)),'m_total',[dataSpeed,[]],#task_info{method= <<"total"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:98--98
                future:await(maps:get('tmp773610783', get(vars)), Cog, [O,DC| Stack]),
                ok,
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:98--98
                put(vars, (get(vars))#{'speed_aux' => future:get_blocking(maps:get('tmp773610783', get(vars)), Cog, [O,DC| Stack])}),
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:99--102
                put(vars, (get(vars))#{'total_speed' => begin
                 ...
                 %% timesmartdel-orchs/MessageAnalyserPlan.abs:103--103
                case (not cmp:eq(maps:get('total_speed', get(vars)),-1)) of
                    true ->  %% timesmartdel-orchs/MessageAnalyserPlan.abs:104--104
                    put(vars, (get(vars))#{'tmp757791801' => cog:create_task(maps:get('dc', get(vars)),'m_getNumberOfCores',[[]],#task_info{method= <<"getNumberOfCores"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                     %% timesmartdel-orchs/MessageAnalyserPlan.abs:104--104
                    future:await(maps:get('tmp757791801', get(vars)), Cog, [O,DC| Stack]),
                    ok,
                     %% timesmartdel-orchs/MessageAnalyserPlan.abs:104--104
                    put(vars, (get(vars))#{'totalCore' => future:get_blocking(maps:get('tmp757791801', get(vars)), Cog, [O,DC| Stack])}),
                     %% timesmartdel-orchs/MessageAnalyserPlan.abs:105--105
                    put(vars, (get(vars))#{'speedPerCore' =>  rationals:rdiv(maps:get('total_speed', get(vars)),maps:get('totalCore', get(vars))) }),
                     %% timesmartdel-orchs/MessageAnalyserPlan.abs:106--106
