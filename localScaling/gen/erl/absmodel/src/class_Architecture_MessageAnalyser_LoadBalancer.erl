...
-record(state,{'class'=class_Architecture_MessageAnalyser_LoadBalancer,'db'=null,'instancesConnected'=null,'nextInstance'=null,'buffer_size'=null,'pending'=null,'inbound_workload'=null,'plan'=null,'deplTimes'=null}).
'init_internal'()->
    #state{}.

 %% architecture.abs:596
    ...
    try
        ...
        case cmp:lt(C:get_val_internal(get(this), 'pending'),C:get_val_internal(get(this), 'buffer_size')) of
            ...
            put(vars, (get(vars))#{'selectedInstance' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'instancesConnected'),C:get_val_internal(get(this), 'nextInstance'),[O,DC| Stack])}),
             %% architecture.abs:649--649
            put(this, C:set_val_internal(get(this), 'pending',(C:get_val_internal(get(this), 'pending') + 1) )),
             %% architecture.abs:650--650
            T_1 = cog:create_task(maps:get('selectedInstance', get(vars)),'m_insertResult',[maps:get('id', get(vars)),O,[]],#task_info{method= <<"insertResult"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog),
            T_1;
            false ->          %% architecture.abs:651--651
