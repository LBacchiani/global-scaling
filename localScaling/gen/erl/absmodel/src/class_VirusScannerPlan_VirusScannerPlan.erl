...
'init_internal'()->
 ...
 %% timesmartdel-orchs/VirusScannerPlan.abs:15
...
'get_val_internal'(#state{'attachmentsManager_LoadBalancerObj'=G},'attachmentsManager_LoadBalancerObj')->
    ...
    G;
 %% timesmartdel-orchs/VirusScannerPlan.abs:17
...
'init'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},[P_cloudProvider,P_virusScanner_LoadBalancerObj,P_messageAnalyser_LoadBalancerObj,P_attachmentsManager_LoadBalancerObj,Stack])->
    ...
    T_1 = (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
        ...
        Callee ->
            %% remote call
            TempFuture = cog:create_task(Callee,'m_addInstanceDescription',[{ dataPair,<<"c4_4xlarge"/utf8>>,m_ABS_StdLib_funs:f_map(Cog,[ { dataPair,dataCostPerInterval,950}, { dataPair,dataPaymentInterval,1}, { dataPair,dataBandwidth,2000}, { dataPair,dataMemory,3000}, { dataPair,dataCores,16}, { dataPair,dataSpeed,80}] ,[O,DC| Stack])},[]],#task_info{method= <<"addInstanceDescription"/utf8>>},Cog),
            future:get_blocking(TempFuture, Cog, [O,DC| Stack])
    end end)(),
    T_1,
     %% timesmartdel-orchs/VirusScannerPlan.abs:31--38
    ...
    T_2,
     %% timesmartdel-orchs/VirusScannerPlan.abs:39--46
    ...
    T_3,
     %% timesmartdel-orchs/VirusScannerPlan.abs:47--54
...
%% --- Methods
 ...
 %% timesmartdel-orchs/VirusScannerPlan.abs:57
 %% timesmartdel-orchs/VirusScannerPlan.abs:57
'm_getVirusScannerInterface'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/VirusScannerPlan.abs:57--57
 ...
 %% timesmartdel-orchs/VirusScannerPlan.abs:58
 %% timesmartdel-orchs/VirusScannerPlan.abs:58
'm_getDeploymentComponent'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/VirusScannerPlan.abs:58--58
 ...
 %% timesmartdel-orchs/VirusScannerPlan.abs:60
 %% timesmartdel-orchs/VirusScannerPlan.abs:60
'm_deploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/VirusScannerPlan.abs:61--61
        put(this, C:set_val_internal(get(this), 'ls_ls_VirusScannerInterface',[C:get_val_internal(get(this), 'ls_VirusScannerInterface') | C:get_val_internal(get(this), 'ls_ls_VirusScannerInterface')])),
         %% timesmartdel-orchs/VirusScannerPlan.abs:62--62
        put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',[])),
         %% timesmartdel-orchs/VirusScannerPlan.abs:63--63
        put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',[C:get_val_internal(get(this), 'ls_DeploymentComponent') | C:get_val_internal(get(this), 'ls_ls_DeploymentComponent')])),
         %% timesmartdel-orchs/VirusScannerPlan.abs:64--64
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[])),
         %% timesmartdel-orchs/VirusScannerPlan.abs:65--65
        T_1 = (fun() -> case O of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
 ...
 %% timesmartdel-orchs/VirusScannerPlan.abs:68
 %% timesmartdel-orchs/VirusScannerPlan.abs:68
'm_undeploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/VirusScannerPlan.abs:69--69
        case (not cmp:eq(C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[])) of
            true ->  %% timesmartdel-orchs/VirusScannerPlan.abs:70--70
            T_1 = (fun() -> case O of
                null -> throw(dataNullPointerException);
                Callee=#object{oid=Oid,cog=Cog} ->
                    %% self-call
            ...
            T_1,
             %% timesmartdel-orchs/VirusScannerPlan.abs:71--71
            put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/VirusScannerPlan.abs:72--72
            put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',m_ABS_StdLib_funs:f_tail(Cog,C:get_val_internal(get(this), 'ls_ls_DeploymentComponent'),[O,DC| Stack]))),
             %% timesmartdel-orchs/VirusScannerPlan.abs:73--73
            put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',m_ABS_StdLib_funs:f_head(Cog,C:get_val_internal(get(this), 'ls_ls_VirusScannerInterface'),[O,DC| Stack]))),
             %% timesmartdel-orchs/VirusScannerPlan.abs:74--74
...
'm_deploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(vars, (get(vars))#{'c4_xlarge_0' => (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
         ...
         %% timesmartdel-orchs/VirusScannerPlan.abs:82--82
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[maps:get('c4_xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_DeploymentComponent')])),
         %% timesmartdel-orchs/VirusScannerPlan.abs:83--83
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_xlarge_0', get(vars)),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/VirusScannerPlan.abs:84--84
        put(vars, (get(vars))#{'odefault___VirusScanner_0_c4_xlarge_0' => object:new(cog:start(Cog,maps:get('c4_xlarge_0', get(vars))),class_Architecture_VirusScanner,[C:get_val_internal(get(this), 'attachmentsManager_LoadBalancerObj'),C:get_val_internal(get(this), 'messageAnalyser_LoadBalancerObj'),[]],Cog,[O,DC| Stack])}),
         %% timesmartdel-orchs/VirusScannerPlan.abs:85--85
        put(vars, (get(vars))#{'coreRequired_odefault___VirusScanner_0_c4_xlarge_0' => 4}),
         %% timesmartdel-orchs/VirusScannerPlan.abs:86--86
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_xlarge_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_xlarge_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___VirusScanner_0_c4_xlarge_0', get(vars)))) ,[O,DC| Stack])}),
         %% timesmartdel-orchs/VirusScannerPlan.abs:87--87
        put(this, C:set_val_internal(get(this), 'ls_VirusScannerInterface',[maps:get('odefault___VirusScanner_0_c4_xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_VirusScannerInterface')])),
         %% timesmartdel-orchs/VirusScannerPlan.abs:88--88
        ...
        T_1,
         %% timesmartdel-orchs/VirusScannerPlan.abs:89--89
        ...
        ok,
         %% timesmartdel-orchs/VirusScannerPlan.abs:90--90
 ...
 %% timesmartdel-orchs/VirusScannerPlan.abs:93
 %% timesmartdel-orchs/VirusScannerPlan.abs:93
'm_undeploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% timesmartdel-orchs/VirusScannerPlan.abs:94--94
        put(vars, (get(vars))#{'odefault___VirusScanner_0_c4_xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_VirusScannerInterface'),0,[O,DC| Stack])}),
         %% timesmartdel-orchs/VirusScannerPlan.abs:95--95
        ...
        T_1,
         %% timesmartdel-orchs/VirusScannerPlan.abs:96--96
        []=(fun Loop ([])->
            ...
            true -> receive
                 ...
                 %% timesmartdel-orchs/VirusScannerPlan.abs:97--97
                T_2 = (fun() -> case C:get_val_internal(get(this), 'cloudProvider') of
                    null -> throw(dataNullPointerException);
                    Callee=#object{oid=Oid,cog=Cog} ->
                        %% self-call
                ...
                T_2,
                 %% timesmartdel-orchs/VirusScannerPlan.abs:98--98
 ...
 %% timesmartdel-orchs/VirusScannerPlan.abs:102
 %% timesmartdel-orchs/VirusScannerPlan.abs:102
'm_patchSpeed'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_dcs_0,Stack)->
 ...
 'dcs' => V_dcs_0 }),
    try
         %% timesmartdel-orchs/VirusScannerPlan.abs:103--116
        put(vars, (get(vars))#{'tmp1380332117' => m_ABS_StdLib_funs:f_entries(Cog,maps:get('dcs', get(vars)),[O,DC| Stack])}),
         %% timesmartdel-orchs/VirusScannerPlan.abs:103--116
        []=(fun Loop ([])->
            case not (m_ABS_StdLib_funs:f_isEmpty(Cog,maps:get('tmp1380332117', get(vars)),[O,DC| Stack])) of
            false -> [];
            true -> receive
                    {stop_world, CogRef} ->
                        cog:task_is_blocked_for_gc(Cog, self(), get(task_info), get(this)),
                 ...
                 %% timesmartdel-orchs/VirusScannerPlan.abs:103--116
                put(vars, (get(vars))#{'entry' => m_ABS_StdLib_funs:f_head(Cog,maps:get('tmp1380332117', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/VirusScannerPlan.abs:103--116
                put(vars, (get(vars))#{'tmp1380332117' := m_ABS_StdLib_funs:f_tail(Cog,maps:get('tmp1380332117', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/VirusScannerPlan.abs:104--104
                put(vars, (get(vars))#{'dc' => m_ABS_StdLib_funs:f_fst(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/VirusScannerPlan.abs:105--105
                put(vars, (get(vars))#{'coreUsed' => m_ABS_StdLib_funs:f_snd(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% timesmartdel-orchs/VirusScannerPlan.abs:106--106
                put(vars, (get(vars))#{'tmp1786425861' => cog:create_task(maps:get('dc', get(vars)),'m_total',[dataSpeed,[]],#task_info{method= <<"total"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                 %% timesmartdel-orchs/VirusScannerPlan.abs:106--106
                future:await(maps:get('tmp1786425861', get(vars)), Cog, [O,DC| Stack]),
                ok,
                 %% timesmartdel-orchs/VirusScannerPlan.abs:106--106
                put(vars, (get(vars))#{'speed_aux' => future:get_blocking(maps:get('tmp1786425861', get(vars)), Cog, [O,DC| Stack])}),
                 %% timesmartdel-orchs/VirusScannerPlan.abs:107--110
                put(vars, (get(vars))#{'total_speed' => begin
                 ...
                 %% timesmartdel-orchs/VirusScannerPlan.abs:111--111
                case (not cmp:eq(maps:get('total_speed', get(vars)),-1)) of
                    true ->  %% timesmartdel-orchs/VirusScannerPlan.abs:112--112
                    put(vars, (get(vars))#{'tmp281759815' => cog:create_task(maps:get('dc', get(vars)),'m_getNumberOfCores',[[]],#task_info{method= <<"getNumberOfCores"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
                     %% timesmartdel-orchs/VirusScannerPlan.abs:112--112
                    future:await(maps:get('tmp281759815', get(vars)), Cog, [O,DC| Stack]),
                    ok,
                     %% timesmartdel-orchs/VirusScannerPlan.abs:112--112
                    put(vars, (get(vars))#{'totalCore' => future:get_blocking(maps:get('tmp281759815', get(vars)), Cog, [O,DC| Stack])}),
                     %% timesmartdel-orchs/VirusScannerPlan.abs:113--113
                    put(vars, (get(vars))#{'speedPerCore' =>  rationals:rdiv(maps:get('total_speed', get(vars)),maps:get('totalCore', get(vars))) }),
                     %% timesmartdel-orchs/VirusScannerPlan.abs:114--114
