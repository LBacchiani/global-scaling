...
%% --- Methods
 ...
 %% architecture.abs:580
 %% architecture.abs:580
'm_analyzeImage'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_messageId_0,V_balancer_0,V_db_0,Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O,
