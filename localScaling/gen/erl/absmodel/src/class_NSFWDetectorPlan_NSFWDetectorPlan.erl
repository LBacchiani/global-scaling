-module(class_NSFWDetectorPlan_NSFWDetectorPlan).
-include_lib("../include/abs_types.hrl").
-behaviour(object).
-export([get_val_internal/2,set_val_internal/3,init_internal/0,get_state_for_modelapi/1,implemented_interfaces/0,exported/0]).
-compile(export_all).

implemented_interfaces() -> [ <<"NSFWDetectorPlan">>, <<"Object">> ].

exported() -> #{  }.

%% --- Internal state and low-level accessors

-record(state,{'class'=class_NSFWDetectorPlan_NSFWDetectorPlan,'cloudProvider'=null,'nsfwDetector_LoadBalancerObj'=null,'ls_ls_NSFWDetectorInterface'=null,'ls_NSFWDetectorInterface'=null,'ls_ls_DeploymentComponent'=null,'ls_DeploymentComponent'=null,'waiting_time'=null}).
'init_internal'()->
    #state{}.

 %% NSFWDetectorPlan.abs:13
...
'init'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},[P_cloudProvider,P_nsfwDetector_LoadBalancerObj,Stack])->
...
'm_deploy'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(this, C:set_val_internal(get(this), 'ls_ls_NSFWDetectorInterface',[C:get_val_internal(get(this), 'ls_NSFWDetectorInterface') | C:get_val_internal(get(this), 'ls_ls_NSFWDetectorInterface')])),
         %% NSFWDetectorPlan.abs:52--52
        put(this, C:set_val_internal(get(this), 'ls_NSFWDetectorInterface',[])),
         %% NSFWDetectorPlan.abs:53--53
        put(this, C:set_val_internal(get(this), 'ls_ls_DeploymentComponent',[C:get_val_internal(get(this), 'ls_DeploymentComponent') | C:get_val_internal(get(this), 'ls_ls_DeploymentComponent')])),
         %% NSFWDetectorPlan.abs:54--54
        put(this, C:set_val_internal(get(this), 'ls_DeploymentComponent',[])),
         %% NSFWDetectorPlan.abs:55--55
        T_1 = (fun() -> case O of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
...
'm_deploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),0,[O,DC| Stack])}),
         %% NSFWDetectorPlan.abs:74--74
        put(vars, (get(vars))#{'odefault___NSFWDetector_0_c4_2xlarge_0' => object:new(cog:start(Cog,maps:get('c4_2xlarge_0', get(vars))),class_EmailProcessingPipelineArchitecture_NSFWDetector,[[]],Cog,[O,DC| Stack])}),
         %% NSFWDetectorPlan.abs:75--75
        put(vars, (get(vars))#{'coreRequired_odefault___NSFWDetector_0_c4_2xlarge_0' => 6}),
         %% NSFWDetectorPlan.abs:76--76
        put(vars, (get(vars))#{'speedPatchMap' := m_ABS_StdLib_funs:f_put(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),( rationals:add(m_ABS_StdLib_funs:f_fromJust(Cog,m_ABS_StdLib_funs:f_lookup(Cog,maps:get('speedPatchMap', get(vars)),maps:get('c4_2xlarge_0', get(vars)),[O,DC| Stack]),[O,DC| Stack]),maps:get('coreRequired_odefault___NSFWDetector_0_c4_2xlarge_0', get(vars)))) ,[O,DC| Stack])}),
         %% NSFWDetectorPlan.abs:77--77
        put(this, C:set_val_internal(get(this), 'ls_NSFWDetectorInterface',[maps:get('odefault___NSFWDetector_0_c4_2xlarge_0', get(vars)) | C:get_val_internal(get(this), 'ls_NSFWDetectorInterface')])),
         %% NSFWDetectorPlan.abs:78--78
        ...
        ok,
         %% NSFWDetectorPlan.abs:80--80
        T_2 = (fun() -> case C:get_val_internal(get(this), 'nsfwDetector_LoadBalancerObj') of
            null -> throw(dataNullPointerException);
            Callee=#object{oid=Oid,cog=Cog} ->
                %% self-call
                Vars=get(vars),
                Result=C:'m_connectInstance'(Callee,maps:get('odefault___NSFWDetector_0_c4_2xlarge_0', get(vars)),[O,DC,Vars| Stack]),
                put(vars, Vars),
                Result;
            Callee=#object{oid=ObjRef,cog=Cog} ->
                %% cog-local call
                V_newInstance = maps:get('odefault___NSFWDetector_0_c4_2xlarge_0', get(vars)),
                State=get(this),
                Vars=get(vars),
                cog:object_state_changed(Cog, O, State),
                put(this,cog:get_object_state(Callee#object.cog, Callee)),
            ...
            Callee ->
                %% remote call
                TempFuture = cog:create_task(Callee,'m_connectInstance',[maps:get('odefault___NSFWDetector_0_c4_2xlarge_0', get(vars)),[]],#task_info{method= <<"connectInstance"/utf8>>},Cog, true),
                future:get_blocking(TempFuture, Cog, [O,DC| Stack])
        end end)(),
        T_2,
        dataUnit
 ...
 %% NSFWDetectorPlan.abs:83
 %% NSFWDetectorPlan.abs:83
'm_undeploy_aux'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    C=(get(this))#state.class,
    put(vars, #{ 'this' => O }),
    try
         %% NSFWDetectorPlan.abs:84--84
        put(vars, (get(vars))#{'odefault___NSFWDetector_0_c4_2xlarge_0' => m_ABS_StdLib_funs:f_nth(Cog,C:get_val_internal(get(this), 'ls_NSFWDetectorInterface'),0,[O,DC| Stack])}),
         %% NSFWDetectorPlan.abs:85--85
...
'm_patchSpeed'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},V_dcs_0,Stack)->
 ...
 'dcs' => V_dcs_0 }),
    try
         %% NSFWDetectorPlan.abs:93--106
        put(vars, (get(vars))#{'tmp739310067' => m_ABS_StdLib_funs:f_entries(Cog,maps:get('dcs', get(vars)),[O,DC| Stack])}),
         %% NSFWDetectorPlan.abs:93--106
        []=(fun Loop ([])->
            case not (m_ABS_StdLib_funs:f_isEmpty(Cog,maps:get('tmp739310067', get(vars)),[O,DC| Stack])) of
            false -> [];
            true -> receive
                    {stop_world, CogRef} ->
                        cog:task_is_blocked_for_gc(Cog, self(), get(task_info), get(this)),
                 ...
                 %% NSFWDetectorPlan.abs:93--106
                put(vars, (get(vars))#{'entry' => m_ABS_StdLib_funs:f_head(Cog,maps:get('tmp739310067', get(vars)),[O,DC| Stack])}),
                 %% NSFWDetectorPlan.abs:93--106
                put(vars, (get(vars))#{'tmp739310067' := m_ABS_StdLib_funs:f_tail(Cog,maps:get('tmp739310067', get(vars)),[O,DC| Stack])}),
                 %% NSFWDetectorPlan.abs:94--94
                put(vars, (get(vars))#{'dc' => m_ABS_StdLib_funs:f_fst(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% NSFWDetectorPlan.abs:95--95
                put(vars, (get(vars))#{'coreUsed' => m_ABS_StdLib_funs:f_snd(Cog,maps:get('entry', get(vars)),[O,DC| Stack])}),
                 %% NSFWDetectorPlan.abs:96--96
                put(vars, (get(vars))#{'tmp1866834685' => cog:create_task(maps:get('dc', get(vars)),'m_total',[dataSpeed,[]],#task_info{method= <<"total"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog,true)}),
                 %% NSFWDetectorPlan.abs:96--96
                future:await(maps:get('tmp1866834685', get(vars)), Cog, [O,DC| Stack]),
                ok,
                 %% NSFWDetectorPlan.abs:96--96
                put(vars, (get(vars))#{'speed_aux' => future:get_blocking(maps:get('tmp1866834685', get(vars)), Cog, [O,DC| Stack])}),
                 %% NSFWDetectorPlan.abs:97--100
                put(vars, (get(vars))#{'total_speed' => begin
                 ...
                 %% NSFWDetectorPlan.abs:101--101
                case (not cmp:eq(maps:get('total_speed', get(vars)),-1)) of
                    true ->  %% NSFWDetectorPlan.abs:102--102
                    put(vars, (get(vars))#{'tmp1737665086' => cog:create_task(maps:get('dc', get(vars)),'m_getNumberOfCores',[[]],#task_info{method= <<"getNumberOfCores"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog,true)}),
                     %% NSFWDetectorPlan.abs:102--102
                    future:await(maps:get('tmp1737665086', get(vars)), Cog, [O,DC| Stack]),
                    ok,
                     %% NSFWDetectorPlan.abs:102--102
                    put(vars, (get(vars))#{'totalCore' => future:get_blocking(maps:get('tmp1737665086', get(vars)), Cog, [O,DC| Stack])}),
                     %% NSFWDetectorPlan.abs:103--103
                    put(vars, (get(vars))#{'speedPerCore' =>  rationals:rdiv(maps:get('total_speed', get(vars)),maps:get('totalCore', get(vars))) }),
                     %% NSFWDetectorPlan.abs:104--104
